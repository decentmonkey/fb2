...
label ep29_dialogues4_lesbian_threesome_victoria_1:
    ...
    melanie_t "Миссис Бакфетт должна уже прийти. Надеюсь, она не проигнорирует эту встречу..."
    ...
    m "А когда должен прийти наш общий друг?"
    ...
    victoria "Вы же хотите, чтобы я вам помогла?"
    # молчание
    mt "Черт! Она сейчас разозлится..."
    mt "А ей ничего не стоит сообщить Маркусу, где меня можно найти!"
    ...
    victoria "Тебе можно трогать только мою попу!"
    ...
    victoria "Теперь на диван! Встань на колени и обопрись на локти!"
    ...
    victoria "Что 'ЭТО'?"
    victoria "Миссис Бакфетт нравится, что я трахаю ее искусственным членом?"
    m "Д-да-а..."
    ...
    victoria "Как же охренительно трахать саму Миссис Бакфетт!"
    victoria "А-а-а-а"
    victoria "Да-а!!!"
