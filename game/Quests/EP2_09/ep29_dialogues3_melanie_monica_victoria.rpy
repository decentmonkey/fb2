...
label ep29_dialogues3_melanie_monica_victoria_1kk:
    ...
    melanie_t "Она ясно дала понять, что присутствие Миссис Бакфетт сегодня обязательно."
    melanie_t "Мне нужно передать это Миссис Бакфетт. Она должна быть сейчас в офисе."
    return
...
label ep29_dialogues3_melanie_monica_victoria_2:
    ...
    menu:
        "Согласиться на предложение Виктории":
            melanie_t "Эта сучка явно что-то задумала..."
            melanie_t "Узнать это можно только одним способом - согласиться, чтобы та пришла к ней в гости"
            pass
        "Отказаться":
    ...
    victoria "Как ты думаешь, вторая подружка не захочет ведь меня расстраивать?"
...
label ep29_dialogues3_melanie_monica_victoria_4:
    # Мелани зайдет в Бифу, тот потребует сегодня от нее фотосессию в черном костюме

label ep29_dialogues3_melanie_monica_victoria_5:
    # фотосессия Мелани

label ep29_dialogues3_melanie_monica_victoria_6:
    # гримерка. Мелани собирается домой. девичник уже скоро
