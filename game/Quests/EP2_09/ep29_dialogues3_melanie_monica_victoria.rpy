#### добавить мысли Мелани при повторной попытке посетить Викторию, Монику на работе
...
##### исправить диалог с Бифом, костюм будет другой
...
label ep29_dialogues3_melanie_monica_victoria_4:
    ...
    biff "Только ты не забыла, что должна сделать одну фотосессию?"
    melanie "Какую фотосессию?"
    biff "В черном костюме, цыпочка."
    # Мелани приподнимает бровь удивленно
    melanie "..."
    biff "Мне нужны фотографии с тобой в этом костюме."
    biff "А не с той цыпочкой, которая притворяется Моникой Бакфетт."
    ...
    menu:
        ...
        "Отказаться (пропуск фотосессии)"
            melanie_t "Я не буду проводить фотосессию в таком откровенном костюме."
            melanie_t "Биф обойдется и без этих фотографий."
            melanie "Биф, я пока не совсем готова к таким фотографиям..."
            melanie "Мне нужно еще немного времени..."
    ...
    melanie_t "Видимо, в этот раз мне не избежать этой фотосессии..."
    ...
    # в заданиях появляется "Провести фотосессию в черном костюме"
    $ log1 = _("Провести фотосессию в черном костюме")
    return
...
label ep29_dialogues3_melanie_monica_victoria_5:
    ...
    menu:
        "Переодеться":
            pass
    # появляется окно выбора костюма, там только один, черный
    melanie "Я сейчас переоденусь и вернусь."
    # через несколько минут
    # в студии появляется Мелани в черном костюме, Алекс смотрит на нее как на богиню
    ...
    # Мелани начинает позировать
    alex_photograph "Итак, мотор!"
    # Мелани меняет позы, Алекс фотографирует
...
##    melanie "Да, конечно. На днях я тебе скажу свое решение."
    # Алекс смотрит на нее с довольной улыбкой
...
############# управление переходит обратно к Монике, сделать мысли Моники ниже
