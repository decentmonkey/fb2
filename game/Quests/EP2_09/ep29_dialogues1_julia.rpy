...
label ep29_dialogues1_julia_5:
    ...
    mt "..." # задумчиво
    mt "Хотя..."
    mt "Мерзкий карьерист, который мне притащил тогда кофе, может мне помочь..."
    ...
    julia "Миссис Бакфетт, Джон и Грета пришли..."
    ...
    m "..."
    # Джон и Грета внимают, Юлия греет уши со своего рабочего места и косится в сторону Моники
    ...
    m "А это недопустимо!"
    m "Одной из главной составляющих налаженной работы я вижу поднятии корпоративного духа в коллективе."
