...
label ep29_dialogues1_julia_7:
    ...
    w6 "Миссис Бакфетт, я как раз планирую, как лучше сделать."
    w6 "А вот Джон только тем и занимается, что кофе пьет целыми днями."
    w6 "Но я не могу так пренебрежительно относиться к поставленной Вами задаче."
