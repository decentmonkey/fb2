...
# мысли
label ep22_5_dialogues4_rayan_2:
    ## не рендерить!!
...
label ep22_5_dialogues4_rayan_3:
    ...
    # указывает рукой на реквизит для фотосъемки
    m "..."
    ...
    ryan "Она будет проходить не только в нашем городе, но и за границей."
    ...
    # затемнение
    # спустя некоторое время Моника стоит в аутфите для съемки, свет приглушен
    ...
    m "Нет! У меня нет времени ходить по всяким выставкам!"
    ...
    m "Я итак потратила кучу своего бесценного времени здесь!"
    m "!!!"
    ryan "Да, Миссис Бакфетт, конечно!"
    ryan "Теперь, в качестве моей благодарности за такую великолепную фотосессию..."
...
label ep22_5_dialogues4_rayan_6:
    ...
    mt "!!!"
    mt "Как посмел этот никчемный Райен ставить мне свои дурацкие условия?!"
    mt "Еще и обнажаться передо мною?!"
    mt "Сволочь! Озабоченная бездарность!!!"
    mt "Он мне за это ответит!"
    return
