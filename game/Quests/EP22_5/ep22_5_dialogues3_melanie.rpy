...
label ep22_5_dialogues3_melanie_2:
    ...
    fitness_instructor "Волнуешься что-ли, как пройдет свидание со мной, ха?!"
    ...
    # Алекс зло
    ## поиграть, как мы любим. а где другая девушка, если поиграть? мне понравилось как было со Стефани, поэтому я
