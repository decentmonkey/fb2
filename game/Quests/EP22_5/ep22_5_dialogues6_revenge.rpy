label ep22_5_dialogues_revenge_quest1:
    ...
    mt "Я знаю кто даст мне ответ на все вопросы..."
    ...
    marcus "Моя жизнь..."
    marcus "Миссис Бакфет... простите..."
    marcus "Но не вы распоряжаетесь ей..."
    m "!!!"
    ...
    marcus "Вы особенная женшина, Миссис Бакфетт."
    marcus "Вы сами не замечаете как меняете людей вокруг вас..."
    marcus "Сильная, но кроме силы в вас есть что-то еще..."
    ...
    marcus "Последний раз, когда она меня просила о чем-то, это было подать ей мою руку..."
    ...
    marcus "У меня есть много ресурсов, которые я могу задествовать..."
