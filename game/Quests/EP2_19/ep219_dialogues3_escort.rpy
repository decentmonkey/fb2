...
label ep219_dialogues3_escort_5:
    ...
    # Линда наклоняется и целует ее в щеку, у Моники ступор, она ожидала совсем иного
    mt "Что происходит?!"
    mt "?!"
    ...
    m "И?.."
    linda "У нее попа меньше, чем у тебя."
	...
	#
    mt "Сначала этот никчемный Адриано! Теперь эта овца!"
    mt "Почему они все говорят, что у меня попа больше?!"
    mt "Это не так!"
    ...
    linda "И чтобы больше заработать денег на своем журнале..."
	...
	#
    m "Не так давно я увидела съемку какой-то девочки в розовом платье..."
    m "Она далеко не соответствует стандартам нашего журнала..."
    m "Я сразу сказала об этом Миссис Бакфетт и она прислушалась к моему мнению."
    m "Больше эта неказистая девочка не появится на нашей съемочной площадке!"
    #
    linda "Я знала, что настоящая Моника Бакфетт прислушивается к тебе!"
    ...
    linda "Я рассказывала, что хочу уйти в карьеру модели и уйти из ВИП-эскорта."
    ...
    linda "Да, хотим."
    linda "Но так как я собираюсь уходить в модели, то я сначала вышвырну администратору из эскорта..."
    ...
    miranda "Да, именно!"
    miranda "Я стану главной и буду отдавать тебе, [monica_hotel_name], самых лучших клиентов!.. Раз Линда хочет увольняться..."
...
############# здесь label ep219_dialogues3_escort_5_loop
    ...
    menu:
        "Я помню, как вы заставили меня раздеться, чтобы принять меня на работу.":
            ...
            menu:
                "Согласиться.":
                    ...
                    pass
                "Отказаться.":
                    pass # не pass - jump на начало меню выбора
            pass

        "Я помню, как Линда заставила меня работать ее реквизитом.": # если это было
            # Моника злорадно
            mt "Сейчас я этим сучкам припомню!.."
            mt "!!!"
        ...
        "Я помню, как вы хотели заставить лизать ваши киски.": # если это было
            # Моника злорадно
            mt "Сейчас я этим сучкам припомню!.."
            mt "!!!"
    ...
    # Моника и ее новые подружки стоят в гостиной Линды
