...
label ep219_quests_victoria1_init:
    ...
    $ add_hook("change_time_evening", "ep219_quests_victoria2_stephanie", scene="global", label="ep219_quests_victoria2_stephanie")
    return
...
label ep219_quests_victoria3_office:
    ...
    $ add_hook("change_time_evening", "ep219_quests_victoria4_melanie", scene="global", label="ep219_quests_victoria4_melanie")
...
label ep219_quests_victoria4_melanie:
    ...
    $ add_hook("change_time_day", "ep219_quests_victoria5_melanie_alex", scene="global", label="ep219_quests_victoria5_melanie_alex")
...
label ep219_quests_victoria6_officeworker5: # Разговор Виктории, Стефани и подхалима у лифта
    ...
    $ add_hook("office_work_process", "ep219_quests_victoria7_melanie_victoria", scene="global", label="ep219_quests_victoria7_melanie_victoria")
    return
