...
default monicaBettyRalphAnal3 = 0 # Моника согласилась н анальный секс с Ральфом

# при условии, что у Бетти была групповуха
# вечером в бывшей спальне Моники
label ep219_dialogues1_ralph_1:
    # Бетти лежит на постели, как обычно,в нижнем белье, читает журнал
    ...
    betty "Например, искать того, кто починит мой утюг?!"
    betty "Почему ты не помог мне с этим?!"
...
label ep219_dialogues1_ralph_2:
    ...
    # проводит рукой по ее груди, потом опускает руку ниже, к трусикам
    ...
    betty "А ты ведешь себя эгоистично, требуя так часто исполнения супружеского долга!"
    ...
    if dialogue_betty_teacher_1_flag == True:
    ...
    betty "ЭЙ!!!"
    # Бетти резко отстраняется от него и садится на кровати, повернувшись лицом к нему
...
label ep219_dialogues1_ralph_3:
    ...
    ralph "А знаешь, чем плохая гувернантка Бетти может порадовать хозяина этого дома?"
    ralph "Она же хочет это сделать?"
    mt "Черт! НЕТ!!!"
    # Моника притворно улыбаясь
    m "Да, очень хочу, Мистер Робертс."
    # Ральф шлепает ее по ягодице
    ...
    menu:
        ...
        "Вот дьявол!": # коррапшн
            $ monicaBettyRalphAnal3 = day # Моника согласилась н анальный секс с Ральфом
            pass
    # Моника в шоке
    mt "ЧТО?!"
    mt "Этот мерзкий старикашка хочет сделать ЭТО в мою попу?!"
    ...
    m "Но я боюсь..."
    ralph "Бетти, ты не представляешь, как я хочу сделать это!"
    ...
    if monicaBettyRalphSeduction8 == True:
        #
        $ notif(_("Моника говорила Ральфу, что ей нужны деньги."))
        #
    ...
    mt "Настнет тот момент, когда все до единого ответят за свои грязные поступки!"
    ...
    ralph "Даааа..."
    ralph "Бетти, какая же ты у меня хорошая!"
    ralph "Вот моя первая Бетти отказала мне."
    ralph "А ты не стала меня расстраивать отказом."
    ...
    if monicaBettyRalphSeduction8 == True:
        ...
        ralph "При следующей нашей встрече я дам тебе еще денег, Бетти."
    ...
    # если Моника сказала Ральфу, что любит его
        ...
        mt "Возможно, я смогу сделать так, чтобы этот мерзкий Ральф понял, что я лучше его провинциалки!"
        m "Мистер Робертс..."
        ralph "Да, Бетти?"
        m "Я же порадовала вас сегодня своим согласием..."
        m "И это было у меня впервые."
...
label ep219_dialogues1_ralph_5:
    ...
    mt "Зато место хозяйки этого дома уже почти МОЕ!"
    mt "!!!"
    return
