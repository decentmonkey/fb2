...
betty "Я согласилась на это только потому, что сегодня посещала фитнесс в городе."
...
steve "Мысль о том, что ты только что тренировала ее на фитнессе, возбуждает меня!"
...
# Бетти исчезает из дома до вечера (она на фитнессе)
