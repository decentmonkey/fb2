...
label ep25_quests8:
    ...
    if cloth_type == "Governess":
        call ep25_dialogues4_map6()
        return False
    if ep25_quests8Flag1 == False:
        $ ep25_quests8Flag1 = True
        call ep25_dialogues4_map4()
