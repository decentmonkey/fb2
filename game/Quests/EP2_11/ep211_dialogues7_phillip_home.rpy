...
label ep211_dialogues7_Phillip_home_1:
    ...
    whore_number_1 "Ты вообще без заработка сегодня осталась бы!"
    ...
    whore_number_1 "И, возможно, он станет платить больше..."
    mt "Хммм..."
    mt "Вполне возможно, что эта никчемная шлюха в чем-то права..."
    mt "Конечно, то что она предлагает сделать - грязно и мерзко..."
    mt "..."
    mt "С другой стороны, я заработаю $ 50."
    mt "И, может быть, этот мерзавец Филипп станет платить мне больше денег..."
...
label ep211_dialogues7_Phillip_home_3:
    ...
    philip "Думаю, это не последняя наша встреча втроем."
