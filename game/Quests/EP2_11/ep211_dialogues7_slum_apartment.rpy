...
# квартира Моники
# если Моника подходит к деревянной тумбочке, то открыв ее находит там домашнюю одежду
label ep211_dialogues6_slum_apartment_9:
    ...
    mt "Это оставил кто-то из прежних жильцов?"
    mt "Фи!"
    img 16992
    mt "Хммм..."
    mt "Хотя..."
...
label ep211_dialogues6_slum_apartment_12:
    ...
    shawarma "Джек снова предлагать Мадаме скидку в следующий суббота!"
    m "Все! Иди! Мне некогда!"
    # ep211_dialogues6_slum_apartment_19 - Джек предлагает помочь с новой мебелью и ремонтом
...
label ep211_dialogues6_slum_apartment_19:
    ...
    m "..."
    menu:
        "Согласиться (в следующем обновлении).":
