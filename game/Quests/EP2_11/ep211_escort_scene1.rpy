...
# если ивент, то одна из двух сцен работают
# доступен повтор этих сцен
# если ждать клиента, то Монику в процессе ожидания могут вызвать вместе с остальными девочка на кастинг в клиенту
