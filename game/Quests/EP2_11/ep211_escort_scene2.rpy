...
label ep211_escort_scene2_3:
    ...
    client "Не просто вести себя так."
    ...
    mt "Эти сучки теперь завидывать будут."
...
label ep211_escort_scene2_4:
    ...
    client "Эй, ребята, привет!"
    client "Хочу представить вам мою девушку. Ее зовут Луиза."
    client "Луиза, это мои коллеги и друзья."
    # показывает на первую пару, потом на вторую
    client "Дэниел и его девушка Эмма."
    client "Марти и его девушка Натали."
    daniel "Привет, Луиза!"
    ...
    marty "Угу..."
    # камера сзади Марти, он листает фотки на порно-сайте (его девушке не видно, что он там смотрит)
    emma "Луиза, расскажи нам, чем ты занимаетесь?"
    ...
    ned "Она по вечерам обычно ведет какие-нибудь переговоры..."
    ...
    m "Да, конечно. Для меня это не составит никакого труда."
    ...
    ned "..."
    # он подает ей бокал и снова отворачивается к Дэниелу
    natalie "Луиза, наши мальчики всегда так себя ведут..."
    ...
    m "Чувствую, мне придется самой покупать ему кольцо и приглашать его на нашу свадьбу."
    # девушки хихикают и смотрят на своих парней
...
label ep211_escort_scene2_5:
    ...
    daniel "Я всегда вижу проституток насквозь!"
    ...
    # ему по телефону отвечает администратор
    ...
    mt "!!!"
    mt "Мерзавец!!!"
    mt "Если я сейчас откажусь, меня выгонят с эскорта!"
    mt "Что же делать?!"
...
label ep211_escort_scene2_8:
    ...
    m "А почему $400?! Разве не должно быть дороже, если больше клиентов?!"
...
label ep211_escort_scene2_13:
    ...
    mt "Они только что изменили своим девушкам!"
