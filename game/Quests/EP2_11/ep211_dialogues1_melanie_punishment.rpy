...
label ep212_dialogues6_melanie_punishment_1:
    ...
    $ log1 = _("Вечером пойти домой к Мелани")
    return
...
label ep212_dialogues6_melanie_punishment_4:
    ...
    melanie "И не ожидаю от него ничего подобного."
    ...
    menu:
        ...
        "Отказаться (пропуск событий с Мелани)":
            ...
            melanie "..."
            melanie "Откажу."
            melanie "Я не буду сниматься ни в каких откровенных фотосессиях."
            # Виктория хмурится и пристально смотрит на Мелани
            victoria "Подружка хочет сказать..."
            # Мелани перебивает ее
            melanie "Не знаю, что там Алекс наговорил тебе... Подружка Виктория."
            melanie "Я на твоем месте не стала бы доверять малознакомому фотографу..."
            melanie "Который только и мечтает о том, чтобы переспать со мной..."
            alex_photograph "!!!"
            melanie "Впрочем, как и все остальные мужчины..."
            victoria "!!!"
            melanie "На этом наша сегодняшняя встреча заканчивается."
            melanie "Спасибо, что навестили меня."
            # затемнение экрана
            return
    ...
    victoria "Только вот бюстгалтер подружке придется снять."
    melanie "???"
    victoria "Он мне не нравится. Без него будет значительно лучше."
    # потом обращается к Алексу
    victoria "Ты согласен со мной, Алекс?"
    # тот смотрит на Мелани с вожделением
    alex_photograph "Да, Мисс Виктория!"
    alex_photograph "Без него будет значительно лучше!"
    # Мелани смотрит на него убийственным взглядом
    melanie_t "Я сделаю это..."
    melanie_t "Все равно потом заберу снимки у этого безмозглого Алекса."
    # Мелани снимает бюстгалтер, Виктория ехидно улыбается
    victoria "Да, так значительно лучше."
...
label ep212_dialogues6_melanie_punishment_5:
    ...
    melanie_t "Тебе недолго радоваться этим кадрам осталось..."
...
label ep212_dialogues6_melanie_punishment_6:
    ...
    mt "Скорее бы эта дрянь свалила отсюда!"
    mt "Вместе с этим фотографом-извращенцем!"
    mt "Который ко всему прочему еще и идиотом оказался!!!"
    mt "Как он мог рассказать все Виктории из-за какой-то фотосессии?!"
    mt "Придурок!!!"
    mt "!!!"
    ...
    alex_photograph "Мисс Виктория, конечно, для меня это не трудно..."
    alex_photograph  "Но я помогаю в продвижении девушкам с такими данными, как у Мелани."
    ...
    victoria "Вы, подружки, пообещали ему просто встречу..."
    victoria "А я пообещала ему больше."
    victoria "Я обещала ему, что он сможет с тобой переспать."
    melanie "!!!"
    # Виктория ехидно
    victoria "Мелани, подружка, ты хотела, чтобы он тебе принес фото."
    ...
    melanie_t "Я задействую все свои связи для этого!"
    melanie_t "!!!"
    ...
    victoria "Отлично!"
    victoria "Алекс, раз уж ты привык все снимать на камеру, то и ваш секс мы снимем."
    victoria "Подружка Мелани любит, когда ее снимают на камеру."
    victoria "Даже во время секса. Да, Мелани?"
    melanie "..." # зло
    victoria "Я не слышу. Ты же хочешь, чтобы я сняла вас с Алексом на камеру?"
    melanie "..."
    menu:
        "Да, хочу...":
            pass
    ...
    victoria "И так как ты, Алекс, будешь занят, то я, так уж и быть, сама готова снять это на камеру."
    ...
    menu:
        ...
        "Отказаться (пропуск сцены)":
            ...
            melanie_t "!!!"
            melanie "Нет."
            melanie "Я не буду этого делать."
            melanie "Тем более, на камеру."
            # Виктория хмурится и пристально смотрит на Мелани
            victoria "Подружка хочет сказать..."
            # Мелани перебивает ее
            melanie "На этом наша сегодняшняя встреча заканчивается."
...
label ep212_dialogues6_melanie_punishment_7:
    ...
    melanie_t "Я уничтожу сучку Викторию!"
    ...
    melanie "Я сделаю все для этого!"
    melanie "!!!"
    return
...
label ep212_dialogues6_melanie_punishment_8:
    # не рендерить!!
    mt "Виктория еще больше обозлилась после отказа Мелани..."
    mt "Надеюсь, что до того момента, как эта сучка придумает очередное наказание для нас..."
    mt "Мы сможем найти способ расправиться с ней."
