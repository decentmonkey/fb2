...
# следующий день после паблик ивента
...
label ep211_dialogues3_photoshoot_2:
    ...
    biff "Миссис Бакфетт уже пришла на фотосессию."
    ...
    biff "И пытаешься спорить, когда я показываю твою задницу, даже без члена в ней, состоятельному инвестору!"
...
label ep211_dialogues3_photoshoot_3:
    ...
    mt "Нжно сходить кк Бифу и послать его к черту!"
