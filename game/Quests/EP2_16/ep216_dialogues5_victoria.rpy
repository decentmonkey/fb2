...
# помимо этого, Виктория предлагает Монике сесть на ее место, чтобы подружка Мелани поиграла с ней немного
# Моника садится и Мелани делает ликинг
# Моника думает, что все делает правильно
# + мысли если был обнаженный кастинг перед Мелани, в зависимости от бичности думает либо жестоко в разрезе мести, либо более мягко
        ...
        "Аккуратно положить розу рядом.":
            ...
            # Виктория ехидно улыбается, Моника испугано смотрит на нее
            # затемнение
# Виктория отпустит Мелани в первом пункте меню, когда Моника ее осудит, а в этом пукте она ее оставит
# Виктория показывает на свою щечку, поцеловать ее на прощание
# потом говорит поцеловать и подружку
# Моника в растерянности и вынуждена чмокнуть ее в попу
