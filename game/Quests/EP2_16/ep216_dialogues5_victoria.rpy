...
label ep216_dialogues5_victoria_1:
    ...
    m "А ты иди работай!"
    m "Хватит о всяких глупостях болтать!"
    # Юлия испуганно
...
label ep216_dialogues5_victoria_4:
    ...
    victoria "Ты не будешь на меня обижаться, что я не подождала тебя, подружка Моника?"
    m "..."
    ...
    # Виктория смотрит вниз на Мелани, раздвигает ноги
    ...
    mt "Черт!"
    mt "!!!"
    victoria "Я считаю, что подружка Мелани не совсем по-дружески поступила..."
