...
label ep216_dialogues5_victoria_4:
    ...
    victoria "Эта роза, мне настолько понравился ее запах, что я даже решила украсить ей стол. Хи-хи!"
    ...
    victoria "Если подружка осуждает Мелани, то она может вернуть розу на место, чтобы снова украсить ей стол."
    m "!???!?"
    menu:
        "Осудить Мелани и воткнуть розу обратно.":
            ...
            # наш девичник закончен
            # Мои подружки могут идти
            # Только подружка Моника, тебе не кажется, что стол будет выглядеть не очень красиво без такой чудесной вазы под цветок
            # Ты разрешишь мне оставить подружку Мелани еще немного.
            # Моника говорит разрешаю
            # Виктория провожает Монику одну
            # На улице Моника думает что неудобно получилось с Мелани, но неизвестно чем бы это закончилось
            # В конце концов, это ее ошибка
            # дается bitchiness
        ...
        "Аккуратно положить розу рядом.":
            ...
            victoria "Хорошо, подружка. Я тоже решила дать подружке Мелани еще один шанс." # подозрительно
            # девичник закончен
            # Моника уходит вместе с Мелани, Мелани подавлена
            # Виктория их провожает
            # На улице Мелани говорит Монике что не хочет общаться и что ей надо скорее идти (без рендера)


    m "Я?!"


    victoria "Да, будь хорошей подружкой..."
    victoria "Поставь розу на место."
    # Виктория пристально смотрит на Монику, та растеряна
    m "..."
    # Моника ставит розу в попу Мелани, возможно у нее получается не с первого раза
    mt "Черт! Черт! Черт!"
