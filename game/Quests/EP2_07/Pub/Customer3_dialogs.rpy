...
label customer3_afterbattle:
    ...
    customer3 "Тогда записывай, я делаю заказ на приватный танец в твоём исполнении."
    customer3 "Или снова будешь врать, что не танцуешь?"
    m "Я не танцую приватные танцы."
    m "Мои выступления проходят только на сцене."
    customer3 "Обманывать не хорошо, милочка"
    customer3 "Давай так, если я куплю приват с тобой, то ты сделаешь мне бесплатный минет, за то что обманываешь."
    m "ЧТООО?!?!! НЕТ!!!!НЕТ!!!"
    mt "А вдруг этот наглец договорится с Джо?"
    mt "Что же тогда делать!? АААААА!!!!!"
    customer3 "АГА! ЗАНЕРВНИЧАЛА!?"
    customer3 "Но зато, если ты не обманщица, я заплачу тебе 10 $ моральной компенсации!"
    customer3 "Что скажешь?"
    mt "Думай, Моника! Думай!Думай!Думай!"
    ...
    mt "А вдруг у него найдуться....тогад ..."
    mt "НЕТ!!!!НЕТ!!!НЕТ!!!НЕТ!!!НЕТ!!!НЕТ!!!"
    menu:
        "Сказать что танец стоит очень дорого.":
            m "Я теперь королева Shiny Hole."
            m "Поэтому приватный танец в моем исполнении стоит очень дорого."
            m "И я сама выбираю для кого станцевать, а кому отказать."
            customer3 "У тебя прекрасная попка, дорогуша! Я хорошо заплачу, что бы ты потрясла ею для меня!"
            mt "Этому не бывать! Извращенец!"
            customer3 "Так что скоро увидимся"
            mt "И не надейся"
            customer3 "А пока принеси мне пива, отмечу нашу договоренность."
            m "На твоем месте, я бы не была столь самонадеянна..."
            customer3 "Неси пиво и не порть мне настрой!"
            return
        "Соврать, сказав что не танецуешь.":
            m "Я же уже сказала, что не танцую приватные танцы"
            m "Это моя привелегия, как королевы Shiny Hole."
            customer3 "Ты как Клер что ли?"
            customer3 "Джо что, решил понабрать одних 'благородных девиц' вместо стриптезершь?"
            customer3 "Что-то я тебе не верю, милочка....я ещё уточню у Джо"
            customer3 "А пока проваливай!"
            mt "Хммм...и правда. А это не плохая идея!"
            mt "Клэр ведь никогда не исполняла приватные танцы для клиентов, не считая того случая, когда она мне помогла."
