...
label customer3_afterbattle:
    ...
    mt "?!?!?!"
    menu:
        "Сказать, что приват стоит очень дорого.":
            ...
            customer3 "У тебя прекрасная попка, дорогуша!"
            customer3 "Я хорошо заплачу, чтобы ты потрясла ею для меня!"
            ...
            m "На вашем месте я бы не была столь самонадеяна..."
            customer3 "Неси пиво и не порть мне настроение!"
            pass
        "Соврать, что Моника не танцует приваты.":
            m "Я же уже сказала, что не танцую приватные танцы!"
            m "Это моя привилегия, как королевы Shiny Hole!"
            customer3 "Ты как Клер что-ли?!"
            customer3 "Джо что, решил понабрать одних 'благородных девиц' вместо стриптезерш?!"
            customer3 "Что-то я тебе не верю, милочка..."
            customer3 "Я еще уточню у Джо!"
            customer3 "А пока принеси мне пива!"
            mt "Хммм... А это не плохая идея!"
            mt "Клэр ведь никогда не исполняла приват для клиентов..."
            mt "Не считая того случая, когда она мне помогла."
            pass
    # уходит - приносит
    m "Ваш заказ."
    customer3 "Ага..."
    customer3 "А теперь проваливай!"
