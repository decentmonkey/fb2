...
label customer12_afterbattle:
    customer12 "Неужели! Изволила подойти...ты королева или официантка?!"
    customer12 "Видишь гость сидит!? Это значит что нужно тащить свою задницу и принимать заказ!"
    # Мон злится
    mt "Похоже в этом пабе собрались все хамы города..."
    customer12 "Неси харчо и пиво! И быстро!"
    m "Да, одну минуту!"
    mt "Хам..."
    # уходит приходит
    customer12 "Ты в соседний город за ним ходила что ли?"
    customer12 "Чего так долго?"
    customer12 "Вот держи и проваливай."
    # платит только за еду
    customer12 "Чего стоишь-то? Ааа....чаевые захотела? На,...попрошайка! И давай проваливай, не стой над душой!"
    # дает один доллар Мон
    mt "Мало того что грубиян, так ещё и жлоб!"
