...
label customer12_afterbattle:
    ...
    customer12 "Неужели! Наконец-то!"
    customer12 "Изволила подойти!"
    customer12 "Ты королева или официантка?!"
    customer12 "Видишь, что гость сидит?!"
    customer12 "Это значит, что нужно тащить свою задницу и принимать заказ!"
    # Мон злится
    mt "Похоже, в этом пабе собрались все хамы города..."
    customer12 "Неси харчо и пиво!"
    customer12 "И быстро!"
    m "Одну минуту..."
    mt "Какой мерзкий тип!"
    mt "Ненавижу его!"
    mt "!!!"
    # уходит приходит
    m "Ваш заказ..."
    customer12 "Ты в соседний город за ним ходила что-ли?!"
    customer12 "Чего так долго?!"
    customer12 "Ты за такую работу еще и чаевые, наверное, хочешь?!"
    customer12 "Не дам ни цента! Не заработала!"
    customer12 "И давай проваливай! Не стой над душой!"
    # Мон уходит
    mt "Мало того что грубиян, так еще и жлоб!"
    mt "Мерзкий никчемный жлоб!"
    return
