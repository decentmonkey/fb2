...
label customer10_afterbattle:
    ...
    mt "Фу! Что за мерзкая благодарность!?"
    # Моника корчит моську отвращения
    customer10 "Или ты можешь подарить мне свой королевский поцелуй сама!"
    customer10 "50 $ - достаточная цена ?!"
    menu:
        m "Королевский поцелуй может подарить лишь новая королева Shiny Hole - [monica_pub_name]!":
            m "А Виолетта не дарит королевские поцелуи...даже за 50 $!"
            customer10 "Овца!"
            return

        mt "Целовать это мерзкое существо...Фу! Но 50 $ мне помогут!":
            # клиент тянеся губами к Монике
            m "Но только скромный королевский поцелуй в щеку..."
