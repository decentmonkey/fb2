...
label customer2_afterbattle:
    ...
    customer2 "Я могу тебя поздравить! Ты стала звездой! Видел твоё выступление - папочке понравилось!"
    customer2 "Теперь наверно будешь перед всеми хвастаться в своей деревне?"
    customer2 "Жопой трясти - это тебе не картошку сажать ... или что там у вас?!"
    mt "Болван...я же говорила что не из деревни"
    mt "Что он вообще несёт? Какая к черту картошка?"
    m "Я из этого города, а не из деревни."
    customer2 "Всего пару недель и уже городская? Ик..."
    customer2 "Это так не работает..."
    customer2 "Эх...вот все вы такие, глупые... из этих своих деревень"
    customer2 "Ладно, неси пива."
    mt "Он вообще слышит что я ему говорю?"
    mt "Я - Моника Бакффет, а не какая-то провинциалка!"
    mt "А ты жалкий неудачник и это отвратительное пиво - лучшее на что ты можешь расчитывать"
    # уходит - приходит
    m "Ваше пиво."
    customer2 "Спасибо,дорогуша."
    customer2 "Вот тебе немного чаевых, съездишь к себе домой - в деревню."
    mt "Пьяный болван!"
