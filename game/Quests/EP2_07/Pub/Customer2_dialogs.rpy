...
label customer2_afterbattle:
    ...
    menu:
        "Конечно, нет! Я - Королева Shiny Hole! А ты - никто!":
            mt "Конечно, нет!"
            ...
            menu:
                ...
                "Мне нужны деньги!":
                    ...
                    # доход 10 $
                    return
        "Я - Королева Shiny Hole! Но все еще без денег...":
            mt "Я - Королева Shiny Hole..."
            mt "Но все еще без денег..."
            mt "Черт!"
            mt "!!!"
            m "Это обойдется тебе в $ 100!"
