...
label customer1_afterbattle:
    ...
    mt "И чего он постоянно ко мне придирается?"
        menu:
        "Быть милой"
            mt "Еслия буду с ним милой, он быстрее сделает заказ и отстанет от меня со своими дурацкими замечаниями"
            m "Добрый вечер, вы готовы сделать заказ?"
            customer1 "Так значит ты умеешь быть вежливой?"
            mt "Жалкий неудачник, хочет что бы перед ним выслуживались."
            customer1 "Умнца, детка. Принеси мне чего-нибудь на свой выбор."
            m "Одну минуту."
            # уходит, приносит бургер
            m "Пожалуйста, ваш заказ."
            mt "Наши лучшие 'помои' для вас, Сэр"
            # Мон улыбается своим мыслям
            customer1 "Вот, держи. И немного чаевых за твою прекрасную улыбку"
            return
        "Ответить грубо":
            # Мон возмущенно
