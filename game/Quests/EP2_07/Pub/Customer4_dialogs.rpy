...
label customer4_afterbattle:
    m "Здравствуйте! Что будете заказывать?"
    customer4 "Привет, симпотичная мордашка!"
    customer4 "Принеси мне Ваш восхитительный Shiny бургер, очень уж он мне нравится."
    mt "Восхитительный  бургер?" # Мон смеется
    # Мон в экстазе, поглощенна воспоминаниями о изысканной жизни
    mt "Это фуа-гра с трюфелем восхитительны, болван! Но откуда тебе знать?"
    mt "Ты наверное и слов таких никогда не слышал..."
    mt "О! Моника, ты достойна своей преждней, роскошной жизни...среди лоска и изыска..."
    mt "С шомпанским и восхитительной 'высокой кухней'!"
    # кадр на клиента
    ...
    customer4 "Как же ее звали....? Погоди....вспомню..."
    customer4 "Ми....Ма... МОНИКА!"
    # Мон в ужасе!!!!!
    mt "АААААААА!!!!! ОН УЗНАЛ МЕНЯ!!!"
    mt "ЧТО ДЕЛАТЬ!?!?!?!? АААААААА!?!?!"
    customer4 "Точно, Моника...в сериале каком-то снимается."
    customer4 "А, нет! Вот сейчас смотрю на тебя, совсем не похожа."
    customer4 "Та - в телике посимпатичнее была."
    mt "Да я! Я! Я самая красивая женщина этого города! И я не какая-то официантка, Я БИЗНЕС-ЛЕДИ! Я - Моника Бакффет!"
    customer4 "Но не растраивайся мордашка, хочешь доллар?"
    # лицо Мон выражает обиду и злость
    # m "Хочу."
    customer4 "Тогда неси скорее Ваш восхитительный Shiny бургер и получишь свой доллар"
    # уходит - приносит
