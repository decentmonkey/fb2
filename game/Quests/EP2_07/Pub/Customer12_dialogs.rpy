...
label customer12_afterbattle:
    ...
    m "До свиданья!"
    customer12 "Подожди...А жопа такая же королевская?"
    customer12 "Я знаю...ты тут ни чего за бесплатно не делаешь..."
    customer12 "Поэтому... 20 $ устроит?"
        menu:
            mt "Для тебя не за какие деньги на свете!":
            ...
            mt "Теперь для меня даже 20 $ большие деньги...!":
                m "Я не стану её оголять..."
                customer12 "А я и не просил...но теперь подумаю об этом!Аха-ха!"
