...
label customer12_afterbattle:
    ...
    customer12 "Эй, сиски, иди сюда!"
    m "Меня зовут [monica_pub_name]."
    m "А не си...кхм..."
    m "Вы хотели сделать заказ?"
    customer12 "Нет, хотел посмотреть на твои сиськи..."
    m "Или делайте заказ или я ухожу!"
    customer12 "Ха! Я и жопу твою зацену, когда уходить будешь!"
    m "Я ухожу!"
    mt "Грубиян!"
    customer12 "Подожди! Я сделаю заказ, хочу ещё раз посмотреть на твои скиськи, когда ты мне принесёшь его!"
    customer12 "Ну ка! Давай, быстро...как козочка спрыгай мне за пивом!"
    mt "Грязное отродье! Обращается со мной как с дешевкой какой-то!"
    m "Ваш заказ."
    mt "Мистер Идиот!"
    customer12 "Спасибо и проваливай!"
    customer12 "Грубиянки не получают чаевые!"
    # клиент смеется над мон
    # Мон злится
    mt "Он оставил меня без чаевых!"
    mt "Пусть в следующий раз сам себя обслуживает!"
    return

label customer12_afterbattle1:
    # Мон плача
