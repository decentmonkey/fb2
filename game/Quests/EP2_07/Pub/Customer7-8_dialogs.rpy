...
label customer78_afterbattle:
    ...
    # кладёт доллар Монике между грудей
    m "Что ты делаешь?!"
    m "Убери руки!"
    m "Я работаю здесь официанткой!!"
    customer7 "Я могу достать оттуда этот бакс, раз тебе не нужны чаевые..."
    m "Не смей ко мне прикасаться!"
    customer7 "Эй! Остынь."
    customer7 "Можешь оставить этот доллар себе, детка!"
    customer7 "А лучше полезай на сцену и сними с себя этот костюмчик!"
    ...
    customer7 "Ну-ка, наклонись вперед! Я положу пару баксов тебе и твоим малышкам!"
    m "..."
    # Моника злобно смотрит
    menu:
        "Послать нахала и уйти без чаевых.":
            m "Оставь свои пару баксов себе!"
            m "Похоже, тебе они нужнее."
            # уйти без чаевых
            mt "Урод!"
            return
        "Я заработала эти чаевые, они мои!":
            # Моника наклоняется
            mt "Лишние деньги мне не помешают..."
            customer7 "Держи, детка!"
            customer7 "Вот твои $ 5! За работу и красоту!"
            mt "!!!"
            return
    return
