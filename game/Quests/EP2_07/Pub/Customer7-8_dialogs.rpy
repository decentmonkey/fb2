...
label customer78_afterbattle:
    ...
    customer7 "Эй, детка! Это твой костюмчик для сцены?!"
     ...
     m "Что ты делаешь?!Убери руки, я работаю здесь официанткой?"
     customer7 "Я могу его достать оттуда, раз тебе не нужны чаевые."
     m "Только посмей ко мне прикоснуться и я...!"
     customer7 "Эй-эй-эй...Остынь. Можешь оставить этот доллар себе, детка!"
     customer7 "А лучше полезай на сцену и сними с себя этот костюмчик, как ты умеешь."
     m "Я же уже сказала, что сегодня работаю здесь официанткой..."
     mt "Здесь одни извращенцы и пьяницы! Похоже мы с Клэр здесь единственные нормальные."
     customer7 "Ну раз не хочешь танцевать, тогда хоть выпить нам принеси....Официантка."
     mt "Нахал! Может плюнуть ему в коктейль?"
     customer7 "Неси пару лонг-дринков, и покрепче..."
     # уходит - приносит
     m "Пожалуйста, ваши коктейли!"
     customer7 "Умница, детка! Ну ка, наклонись вперёд, я положу пару баксиков тебе и твоим малышкам!"
     # Мон злобно смотрит
        menu:
            "Послать нахала и уйти без чаевых":
                m "Оставь свои баксики себе! Похоже тебе они нужнее."
                # уйти без чаевых
                mt "Урод!"
                return

            "Я заработала эти чаевые, они мои."
                # протянуть руку для чаевых
                # Мон наезжает на нахалов
                m "Давай сюда, я их заработала!"
                customer7 "Прости, детка! Не хотел тебя обидеть."
