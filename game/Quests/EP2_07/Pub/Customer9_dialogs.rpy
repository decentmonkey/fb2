...
label customer9_afterbattle:
    ...
    m "Что будете заказывать?"
    customer9 "Горячая киска, ну здравствуй!"
    customer9 "Я рад, что ты ко мне подошла."
    customer9 "Сегодня я принес тебе подарочк, хочешь его получить?"
    customer9 "Присаживайся к Санте на колени."
    mt "К черту такого Санту!"
    m "Мне не нужен твой подарочк, можешь его оставить себе!"
    customer9 "Ладно, сегодня Санта добрый, поэтому эта проказница всё равно получит то, что принёс ей Санта."
    # кладет маленькую коробочку на стол
    customer9 "Эта проказница хочет открыть свой подарочек?"
    mt "Интересно... что там? Может это украшение? Я смогу продать его и выручить немного денег. А деньги мне сейчас не помешали бы."
    m "Я открою его, но только из вежливости."
    # Мон открывает коробочку, а там кружевные трусы
    m "Трусы?"
    # Мон кидает их на столик
    customer9 "Я хотел забрать твои трусики, когда ты выступала, надеялся ты кинешь их мне."
    customer9 "Мммм....трусики с твоей горячей киски."
    customer9 "Но не вышло..."
    customer9 "Поэтому я решил что ты можешь поносить ЭТИ трусики для меня. А я буду их нюхать и облизывать вечерами, играя со своим дружком."
    customer9 "Ну как, тебе нравится моя идея?"
    mt "ЧТО?!?!?!? ДЫ КАК ТАКОЕ ВООБЩЕ МОЖЕТ НРАВИТСЯ!?!?!"
    m "Я не буду этого делать! Сам носи свои трусы и дро... и делай с ними, что хочешь!"
    customer9 "А если я заплачу тебе 50 $ ? Ты носи их, а потом отдашь мне."
    customer9 "Что скажешь?"
        menu:
            "Отказаться":
                m "Я уже сказала нет! Но могу повторить ещё раз. НЕТ!"
                mt "Грязное животное!"
                customer9 "Киска растроила Санту!"
                customer9 "Проваливай, плохая киска!"
                return

            "50 $ ?..."
                mt "У меня сейчас такое тяжелое положение, каждый доллар на счету."
                mt "О, Боже! На какие ужастные вещи мне приходится идти, чтобы заработать жалкие гроши!"
                mt "Собирись, Моника! Тебе нужны даже эти несчастные 50 $ !"
                m "Я одену их только за 500 $!"
                customer9 "Эти трусы стоят 6 $!"
                m "Тогда носи их сам!"
                customer9 "200 $!"
                m "4000 $ и ни центом меньше!"
                customer9 "Я подумаю, детка..."
                # Моника уходит
                return
    return
