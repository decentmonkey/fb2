...
label ep214_dialogues3_escort_6:
    ...
    client "Я не смогу заплатить за двоих."
    client "Дело в том, что..."
    m "За нее не надо платить, Мистер."
    m "Она будет для Вас в качестве небольшого презента от нашего ВИП-эскорта."
    m "Специальное предложение только для самых лучших клиентов."
    m "Таких как Вы, Мистер."
...
label ep214_dialogues3_escort_7:
    ...
    client "Мисс [monica_hotel_name]..."
    client "Я хотел бы, что бы вторая девочка тоже поучаствовала..."
    ...
    mt "Хи-хи!"
    m "Да, Мистер. Пусть она тоже поучаствует."
    # клиент поворачивается к брюнетке
    client "Садись рядом со мной."
    client "И поцелуй эту прекрасную ножку."
    ...
    m "Ну? Чего ты ждешь?"
    girl_1 "!!!"
    # злая брюнетка подхожит и садится рядом с клиентом
    ...
    client "Соси!"
    client "Вот так, дааа..."
    client "Облизывай ее польчики еще!"
    client "Скажи, они великолепны, да?"
    # брюнетка отстраняется и зло смотрит на Монику
    girl_1 "!!!"
    ...
    mt "Хи-хи!"
    # затемнение
    # Моника сидит у изголовья кровати, где подушки
    # голая брюнетка сидит посередине кровати
    ...
    client "Я использовал бы ее зад..." # указывает на попу брюнетки
    menu:
        "Я вам позволяю, Мистер.":
            pass
    ...
    girl_1 "Я не..."
    # Моника ее перебивает
    m "Ты снова пытаешься перечить клиенту?"
    ...
    # затемнение
    # голый клиент лежит на кровати сверху на брюнетке, Моника также сидит у изголовья
    ...
    mt "Теперь ты знаешь свое место, шлюшка!"
    mt "!!!"
    ...
    girl_1 "Эй, а мне заплатить?!"
    m "Здесь за все уже оплачено."
    girl_1 "Сучка!"
