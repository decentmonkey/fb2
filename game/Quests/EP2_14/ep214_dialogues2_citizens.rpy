...
default monicaPerryMommyDebt7 = False # Моника сделала ликинг Перри, но в хостеле не осталась
...
default monicaCitizensPunksBlowjob2 = False # Моника побила панков и выгнала их из квартиры
default monicaCitizensPunksBlowjob3 = False # Моника облизала мошонку панку за 2 бакса, когда делала минет
default monicaCitizensPunksBlowjob4 = False # Моника сделала титсджоб второму панку за 5 баксов
...
label ep214_dialogues2_citizens_1:
    ...
    citizen4 "Вот тааак..."
    citizen4 "Ааааа..."
    # в этот момент мимо тупика с пилоном идет Перри, она одета в красное платье Моники
    # Перри останавливает и присматривается к Монике, потом подбегает к ним и начинает орать
    perry "Ах ты сучка!!!"
...
#### если Моника сбежала, а потом передумала и вернулась к пилону, то диалог начинается отсюда
    ...
    perry "Ты сама оставила свое гребаное платье в моем хостеле!"
    perry "Я его у тебя не забирала!"
    perry "Но теперь оно МОЕ."
    perry "И ты мне должна 50 000 баксов, сучка!"
    # Моника начинает возмущаться, но прерывается на полсулове
    m "Я не..."
    # т.к. появляется мамочка вместе с одной из проституток с точки (не с серой мышью, а с другой)
    mommy "Перри, что здесь происходит?"
    mommy "Вас слышно на всю улицу."
    # Перри возмущенно
    perry "Вы представляете, я нашла ту воровку, которая должна мне деньги!"
    perry "Оказывается, она здесь обслуживает клиентов!"
    perry "Вот она!" # указывает на Монику
    perry "Я застала ее, когда она отсасывала у одного из них!"
    perry "За 100 баксов!"
    # показывает телефон в своей руке
    perry "У меня есть доказательство!"
    perry "Я сфотографировала, как она это делала!"
    m "!!!"
    m "Я не воровка!"
    m "Я ничего не крала у тебя!"
    m "Это она забрала у меня МОЕ платье!"
    ...
    # мамочка вступает в разговор, обращается к Монике
    mommy "Девочка, ты..."
    # Моника перебивает ее
    m "Я не девочка! Говорите 'Мэм'!"
    perry "Ты как разговариваешь с Мамочкой, сучка?!"
    ...
    mommy "В противном случае, мы будем вынуждены обратиться к полицейским."
    m "ЧТОО?!"
    m "?!?!?"
    m "???!!!!!?!?!?"
    # Перри злорадно
    ...
    perry "Слышала, воровка, что сказала Мамочка?"
    perry "Если не хочешь оказаться в полицеской камере..."
    perry "Будешь приходить ко мне в хостел и отдавать долг!"
    perry "И чтобы каждую неделю приносила мне МОИ деньги! Поняла?"
    perry "Сучка!"
    # Перри уходит
    mt "Вот дьявол!"
    ...
    mt "А пока что я буду отдавать ей деньги, чтобы их Мамочка не вызвала полицию!"
    mt "!!!"
    mt "Еще эта ненормальная старая шлюха решила, что я хочу работать у нее!"
    mt "Что за бред?!"
    mt "Я никогда не соглашусь на такое!!!"
    mt "НИ-КОГ-ДА!!!"
    $ log1 = _("Теперь мне нужно каждую неделю приносить гребаной Перри деньги в счет оплаты долга. И еще половину заработка у пилона отдавать старой шлюхе Мамочке! Они угрожают мне полицией! Черт!") # квест-лог
    return
...
label ep214_dialogues2_citizens_3:
    # не рендерить!!
    if monicaPerryMommyDebt3 == True:
        mt "Эта мерзкая дрянь Перри меня сфотографировала!"
        mt "А что, если я не буду отдавать ей деньги и она обратиться в полицию?!"
        mt "?!?!?!"
        mt "Мне ни в коем случае нельзя допустить этого!"
        mt "Я не хочу снова оказаться в тюремной камере!"
        mt "!!!"
    return
...
label ep214_dialogues2_citizens_4:
    # не рендерить!!
    if monicaPerryMommyDebt2 == True or monicaPerryMommyDebt3 == True:
...
label ep214_dialogues2_citizens_7:
    ...
    mt "Какой кошмар!"
    mt "А что, если эта сучка Перри обратиться в полицию?!"
    mt "У нее есть моя фотография, на которой я и этот ублюдок!"
    mt "Моника, как ты могла допустить подобное?!"
    # подходит к Перри
    perry "А, воровка пришла!"
    m "Я не воровка!"
    m "Не называй меня так!"
    perry "И что ты мне сделаешь?"
    ...
    perry "Будешь спорить со мной, воровка, отдавать будешь вообще 100 000 баксов!"
...
#### + возможность скипнуть это
    ...
    perry "Иначе Мамочка сказала, что ты уедешь в полицию!"
    mt "!!!"
    menu:
        "Уйти!":
            # Моника зло
            ...
            perry "Тогда твой долг вырастет на 1 000 баксов, воровка!"
            m "Да пошла ты!"
            mt "Гребаная извращенка!"
            mt "Какая же она мерзкая! Фу!"
            mt "!!!"
        ...
        "Отдать деньги.":
            ...
            m "Перри, я могу тебе отдать сейчас $ 20." # может сделать так, чтобы она отдавала 20 или 30 процентов от имеющихся у нее денег
            ...
            menu:
                "Согласиться и не оставаться в хостеле на ночь.":
                    # Моника в сомнениях
                    mt "Фууу!!!"
                    mt "Как она может предлагать мне подобную гадость?!"
                    mt "?!"
                    mt "С другой стороны..."
                    mt "Конечно, я не собираюсь ночевать в этой вонючей и грязной ночлежке!"
                    mt "Но плюс $ 10 к оплате долга..."
                    mt "Моника, неужели ты способна согласиться на такое?!"
                    mt "Но ведь об этом никто не узнает."
                    mt "Зато сумма долга станет меньше."
                    mt "Черт!"
                    ...
                    perry "Можешь делать это хоть каждый день, я не против."
                    m "Нет!"
                    perry "Мое дело - предложить тебе, думай сама."
                    perry "Я засчитываю 10 баксов в счет оплаты долга."
                    perry "И можешь остаться сегодня на ночь в номере."
                    m "Я не собираюсь ночевать ЗДЕСЬ!"
                    m "!!!"
                    perry "Жду тебя {c}через неделю!{/c}"
                    perry "Если не придешь, то твой долг увеличится на 1 000 баксов!"
                    perry "Поняла меня?"
                    ...
                    m "Да!"
                    # Моника уходит
                    $ monicaPerryMommyDebt7 = True # Моника сделала ликинг Перри, но в хостеле не осталась
                    return
                "Согласиться и остаться в хостеле на ночь.":
                    # использовать имеющиеся арты с предыдущего пункта!!
                    # Моника в сомнениях
                    mt "Фууу!!!"
                    mt "Как она может предлагать мне подобную гадость?!"
                    mt "?!"
                    ...
                    $ monicaPerryMommyDebt8 = True # Моника сделала ликинг Перри и осталась в хостеле на ночь
                    return
                "Нет! Ни за что!":
        ...
        "Отработать.":
            menu:
                "Отработать и не оставаться в хостеле на ночь.":
                    # переход к соотв. пункту меню выше
                    return
                "Отработать и остаться в хостеле на ночь.":
                    # переход к соотв. пункту меню выше
                    return
    return
...
label ep214_dialogues2_citizens_10:
    ...
    mt "Как представлю, что на ней спали какие-нибуд мерзкие людишки..."
    mt "Фи!"
    ...
    mt "Ты забудешь всех этих людишек как страшный сон."
    return
...
label ep214_dialogues2_citizens_10b:
    ...
    perry "То можешь прийти вечером и полизать мою киску. Аха-ха!"
...
label ep214_dialogues2_citizens_13:
    # не рендерить!!
    if monicaPerryMommyDebt6 == True and monicaPerryMommyDebt7 == False and monicaPerryMommyDebt8 == False:
        mt "Фу!"
        mt "Как она может предлагать мне подобную гадость?!"
...
label ep214_dialogues2_citizens_14:
    ...
    # Моника зло
    m "Нет!"
    m "Вообще-то, у меня есть квартира!"
...
label ep214_dialogues2_citizens_15:
    ...
    citizen1 "Эй! Я тоже!"
    citizen1 "Давай, один пойдет отольет в туалете, а второй - на кухню в раковину."
    citizen2 "Или здесь в окно!"
    ...
    # Моника орет
    m "Да, не моя! Сутенера!!!"
    m "Еще слово и я звоню ему, чтоб он вас отсюда вышвырнул!!!"
    ...
    citizen1 "Мы просто вместе сходим отольем и вернемся!"
    # Моника стоит в комнате злая
    mt "ААААА!!!"
    mt "Бесят!!!"
    mt "!!!"
    # звук смеха панков из туалета
    mt "Твою мать!"
    mt "Что там происходит?!"
    # Моника выходит из комнаты
    # затемнение
    # туалет Моники
    # Моника заходит
    # один из панков стоит на унитазе сверху и писает в унитаз, а второй писает в душ или в бочку
    # либо один стоит на унитазе и мочится в бочку, а второй просто в унитаз
    # кто-то из них, либо оба курят
    mt "!!!"
    menu:
        "Выгнать их!!! (прерывание квеста)":
            # Монику бомбит
            mt "Чертовы идиоты!"
            mt "Гребаные кретины!"
            mt "!!!"
            # затемнение, звук без каблуков
            # звук скрип дерева, или деревянная вещь ломается
            # снова бег каблуков
            # кадр, туалет
            # панки все еще мочаться
            # Моника забегает в туалет, в руках оторванная от стены рыба
            m "ААААА!!!"
            m "Пошли отсюда на хрен!!!"
            # лупит рыбой одного по спине
            citizen1 "Ай!"
            citizen1 "Больно же!"
            # Моника размахивается и лупит еще раз
            citizen1 "АЙ!!!"
            # размахивается лупит второго
            citizen2 "Все-все!"
            citizen2 "Теть! Ай!"
            citizen1 "Мы не будем больше!"
            # Моника снова лупит их
            m "ВОН ОТСЮДА!"
            m "ОБА!"
            m "СЕЙЧАС ЖЕ!!!"
            # снова удар по одному, по второму
            citizen1 "АЙ!!!"
            citizen2 "Да хватит! Больно!"
            citizen2 "ОЙ!!!"
            citizen1 "Тим, погнали отсюда!"
            citizen1 "Она на всю башку больная!"
            # затемнение, топот
            # смена кадра
            # Моника стоит в комнате, злая как собака, стул валяется на полу, в руках рыба
            mt "Бесполезные!"
            mt "Никчемные!"
            mt "Отбросы общества!"
            mt "Ненавижу!!!"
            mt "!!!"
            # смотрит на рыбу в своей руке
            mt "Что ж..."
            mt "Зато я нашла достойное применение этой жуткой рыбе..."
            # если была сцена с Джо и Клэр в пабе
            mt "У Клэр есть хлыст от извращенцев."
            mt "А у меня будет рыба от извращенцев!"
            $ monicaCitizensPunksBlowjob2 = True # Моника побила панков и выгнала их из квартиры
            return
        "Не выгонять. Мне нужны деньги.":
            pass
    ...
    mt "А тебе нужно возвращать долг извращенке Перри!"
    mt "И еще много чего нужно!"
    mt "Поэтому твоя цель - заработать денег!"
    mt "!!!"
    # в комнату заходят Тим и Том
    citizen2 "Заждалась нас, теть?"
    citizen1 "Мы готовы."
    citizen1 "Начнем?"
    m "Нет!" # зло
    ...
    mt "!!!"
    menu:
        "Встать на колени и взять в рот член.":
            ...
            menu:
                "Лизать яйца Тима.":
                    ...
                    # Моника берет член в рот
                    $ monicaCitizensPunksBlowjob3 = True # Моника облизала мошонку панку за 2 бакса, когда делала минет
                    pass
                "Нет!":
            ...
            citizen2 "Оооох, твою мать! Кончу сейчас!"
            citizen2 "ОООО!!!"
            citizen2 "ОООО, кончаю!!!"
            menu:
                ...
                "Кончить на грудь Моники.":
                    ...
                    mt "!!!"
                    pass
    citizen2 "Это так крутоооо, Том!"
    # Том стоит и продолжает дрочить себе
    citizen1 "Надо было не покупать пиво."
    citizen1 "Сейчас она и мне отсосала бы."
    citizen1 "В следующий раз я буду первый!"
    citizen2 "Договорились, чувак."
    # Моника зло на них смотрит, вытирая рот
    mt "Никакого следующего раза не будет!"
    mt "Два никчемных идиота!"
    mt "Что бы я еще раз пустила в свою квартиру кого-то!!!"
    mt "Ни за что!!!"
    # Том со своим стояком подходит к Монике
    citizen1 "Теперь моя очередь, теть."
    # Моника зло на него смотрит
    mt "Ненавижу!"
    mt "!!!"
    citizen1 "Дрочи!"
    # Моника берет его член в руку и начинает водить рукой
    citizen1 "Дааа!!!"
    citizen1 "Если подрочишь мне своими сиськами, я тебе доплачу 5 баксов!"
    citizen1 "Тебе какая разница, рукой или сиськами?"
    citizen1 "Это же не сосать стояк!"
    m "..."
    menu:
        "Согласиться.":
            mt "Фу! Я не хочу прикасаться к нему своей великолепной грудью!"
            mt "!!!"
            mt "С другой стороны, он готов доплатить за это..."
            mt "А мне нужны деньги..."
            # Моника зло на него смотрит
            m "5 долларов сверху? Точно?"
            citizen1 "Да, теть!"
            m "Сядь на кровать!"
            # Том садится на кровать, Моника садится перед нима на пол
            # обхватывает грудями его член
            # титсджоб
            citizen1 "Уууууу!!!"
            citizen1 "Охренеееееть!"
            citizen1 "Вот это сиськиии!"
            citizen1 "ААА, ДААА!!!"
            # кончает
            menu:
                "Кончить на лицо Моники.":
                    ...
                    citizen1 "АААААААА!!!"
                    # Моника зло на него смотрит
                    mt "Идиот! Испачкал мое лицо этой гадостью!"
                    mt "!!!"
                    mt "!!!!!!"
                    pass
                "Кончить на грудь Моники.":
                    ...
                    citizen1 "АААААААА!!!"
                    # Моника зло на него смотрит
                    mt "Идиот! Испачкал мою прекрасную грудь этой гадостью!"
                    mt "!!!"
                    mt "!!!!!!"
                    pass
            $ monicaCitizensPunksBlowjob4 = True # Моника сделала титсджоб второму панку за 5 баксов
            pass
        "Нет! Я не хочу делать это!":
            mt "Я не собираюсь прикасаться к нему своей грудью!"
            mt "Фу!"
            mt "Тем более, за каких-то 5 долларов!"
            m "Нет!"
            m "Только рукой!"
            citizen1 "Тогда давай, продолжай!"
            # Моника продолжает дрочить ему
            citizen1 "МММММММ!"
            citizen1 "ДААА!!!"
            # кончает
            menu:
    ...
    if monicaCitizensPunksBlowjob3 == True and monicaCitizensPunksBlowjob4 == True:
        citizen1 "Это было круто, теть!"
        citizen2 "Вот твои 28 баксов."
    if monicaCitizensPunksBlowjob3 == True and monicaCitizensPunksBlowjob4 == False:
        citizen1 "Это было круто, теть!"
        citizen2 "Вот твои 23 бакса."
    if monicaCitizensPunksBlowjob3 == False and monicaCitizensPunksBlowjob4 == False:
        citizen1 "Это было круто, теть!"
        citizen2 "Вот твой 21 бакс."
    if monicaCitizensPunksBlowjob3 == False and monicaCitizensPunksBlowjob4 == True:
        citizen1 "Это было круто, теть!"
        citizen2 "Вот твои 26 баксов."
    # дают ей деньги
...
label ep214_dialogues2_citizens_15:
    ...
    # затемнение
    # смена кадра
    # Моника стоит обнаженная, в полоборота к художнику (или спиной к нему, или лежит на кушетке, отвернувшись)
    ...
    # поправляет прядь волос, и как бы невзначай задевай рукой ее грудь
    ...
    citizen7 "Оооох..."
    # берет кисть, макает туда, куда кончил и наносит мазок на картину с Моникой
...
label ep214_dialogues2_citizens_16:
    ...
    mt "Мне не нужны проблемы с этой Мамочкой!"
    mt "Она сказала, что обратиться к полицейским, если я не буду делиться с ней!"
    mt "Мне ни в коем случае нельзя допустить этого!"
...
label ep214_dialogues2_citizens_18:
    ...
    if monicaCitizensPunksBlowjob3 == True and monicaCitizensPunksBlowjob4 == True:
        m "Я заработала сегодня $ 28."
    if monicaCitizensPunksBlowjob3 == True and monicaCitizensPunksBlowjob4 == False:
        m "Я заработала сегодня $ 23."
    if monicaCitizensPunksBlowjob3 == False and monicaCitizensPunksBlowjob4 == False:
        m "Я заработала сегодня $ 21."
    if monicaCitizensPunksBlowjob3 == False and monicaCitizensPunksBlowjob4 == True:
        m "Я заработала сегодня $ 26."
    if monicaCitizensArtistNudeModel2 == True:
...
#    $ monicaPerryMommyDebt9 = True # Моника отдала Мамочке ее долю
    ...
    if monicaPerryMommyDebt5 == True:
        ...
        m "Почему я должна отдавать такую сумму?!"
        m "Всего за одну ночевку в ее хостеле?!"
        mommy "Я не знаю, о чем вы с ней договаривались."
        mommy "Перри мне сказала, что собирается вызывать полицию."
        mommy "Тебе лучше с ней договориться, девочка."
    else:
        m "Да, ходила."
        m "Я отдала ей часть денег..."
        mommy "Хорошо."
        mommy "Не нужно лишний раз привлекать внимание полиции."
    mommy "Как заработаешь еще, не забудь принести мне мою долю."
    mommy "Можешь идти."
    mommy "Не нужно тебе долго находиться на этом месте и создавать моим девочкам конкуренцию."
    return
...
label ep214_dialogues2_citizens_19:
    ...
    mt "Эта старая шлюха постоянно говорит мне про полицию."
