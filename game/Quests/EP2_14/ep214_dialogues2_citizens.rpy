...
#### если Моника сбежала, а потом передумала и вернулась к пилону, то диалог начинается отсюда
    ...
    mt "А пока что мне придется отдавать ей деньги, чтобы их Мамочка не вызвала полицию!"
    mt "!!!"
    mt "Еще эта ненормальная старая шлюха решила, что я хочу работать у нее!"
    mt "Что за бред?!"
    mt "Я никогда не соглашусь на такое!!!"
    mt "НИ-КОГ-ДА!!!"
    $ log1 = _("Теперь мне нужно каждую неделю приносить гребаной Перри деньги в счет оплаты долга. И еще половину заработка отдавать старой шлюхе Мамочке! Они угрожают мне полицией! Черт!") # квест-лог
    return
...
#### + возможность скипнуть это
    ...
    menu:
        ...
        "Отдать деньги.":
            ...
            "Отлизать чтобы остаться ночевать в хостеле"

        "Отлизать."
            # Дается возможность остаться в хостеле
            # - 10$ долга
