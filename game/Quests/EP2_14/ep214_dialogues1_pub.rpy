...
label ep214_dialogues1_pub_14:
    ...
    banker "Эй, крошка."
    banker "Ты чего там застыла?"
    banker "Лезь на стол и показывай мне свою попку."
    ...
    # заходит манерная Молли, она без жилета, только в маске и трусиках
    ...
    # в дверях стоит недовольная Клэр, в руках ее хлыст для извращенцев, одета в трусики, бра и маску
    # Эшли радостно
    ashley "Клэр!"
    mt "Она пришла!"
    mt "Она сделала это!"
    ...
    m "Меньше надо коктейлей пить после работа, задница станет меньше!"
    molly "Ах ты дрянь!"
    # толкает Монику
    # Эшли шипит на них
    ashley "А ну-ка тихо!!!"
