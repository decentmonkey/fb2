...
label cit3_naked_boobs_dance_1st:
    ...
    img 13276
    mt "Да заткнись ты уже... Я бы на такое не согласилась и за 7000 долларов... Хотя..."
    img 13277
...
label cit3_naked_boobs_dance_variant2:
    ...
    img 13303
    citizen3 "Знаешь, детка, сейчас не самое удачное время... У меня не так мноого налички. Но у меня есть прекрасный товар. Хочешь?"
    img 13304
    menu:
        "Мне нужны деньги.":
            pass
