...
label cit8_naked_boobs_dance_1st:
    ...
    m "Все, достаточно!"
    citizen8 "Как скажешь. Да, эффект сисек работает! Даже если бы ты двигалась не умело, я бы все равно заплатил за твои голые сиськи."
    # дает деньги
...
label cit8_naked_boobs_dance_variant2:
    ...
    citizen8 "Ты танцуешь на пилоне и мы как будто в сптип клубе, но это не так."
    ...
    citizen8 "Пусть будет обычный танец. Можешь начинать."
    # движение на пилоне
