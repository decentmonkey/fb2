...
#    mt "Пожалуй, можно это сделать,
    mt "но я заберу все ваши деньги! И не разденусь!"
    mt "Я не собираюсь раздеваться при этих болванах."
    ...
    m "Выбор за вами! Я и так собираюсь позволить вам слишком много для таких как вы!"
    # не довольны
