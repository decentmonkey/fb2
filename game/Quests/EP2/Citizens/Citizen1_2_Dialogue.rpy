...
label cit1_2_naked_boobs_dance_1st:
    ...
    m "Но вы же видели, как я танцую.."
    citizen1 "Эм...Ну да..."
    ...
    m "Что?! Да как ты можешь такое говорить?!"
    citizen1 "Ой, тетя! Не кипятись, я пошутил..."
    m "Да как вы можете так шутить?! Отвернитесь!"
    # отворачиваются
...
label cit1_2_naked_boobs_dance_variant2:
    ...
    # поворачиваются, моника стоит с голыми сиськами
    citizen1 "Начинай!"
    mt "Что-то они какие-то молчаливые..."
    # движение на пилоне
    citizen1 "Отлично!"
    # движение на пилоне еще
    citizen1 "Не плохо!"
    mt "Да что с ними сегодня? Они ведут себя не как обычно..."
    # движение на пилоне еще
