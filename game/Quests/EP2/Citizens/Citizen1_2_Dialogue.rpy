...
#    mt "Пожалуй, можно это сделать,
    ...
    citizen1 "Мы платим тебе доллар, то при двойном тарифе платим два. Понятно?"
    m "Понятно."
    ...
    mt "Раньше бы я не позволила вам деже стоять со мной рядом!"
    # не довольны
...
label cit1_2_grooping_regular:
    ...
    m "Я не шлюха!"
    mt "Вы деже не представляете кто я такая!"
