...
label cit1_2_grooping_first:
    ...
    menu:
        ...
        "А я не хочу!":
            m "А я не хочу!"
            return False
    mt "Пожалуй, можно это сделать, но я заберу все ваши деньги! И не разденусь!"
    m "Я хочу 100 долларов!"
    ...
    citizen1 "Да как так то? Черверной тариф!"
    m "Выбор за вами..."
    # не довольны
    ...
    menu:
        "Терпеть.":
            mt "Еще немного потерпеть... Да и мы вроде договорились..."
            pass
        "Это уже перебор!":
            mt "Моника, до чего ты дошла... Но это уже никуда не годится..."
...
label cit1_2_grooping_regular:
    ...
    menu:
        ...
        "Я слушаю.":
            ...
            mt "10 долларов... Не так уж и мало..."
            ...
            menu:
                ...
                "Нет.":
                    m "Даже не думайте!"
                    citizen1 "Ха-ха! Тетя, ты даже не знаешь склолько желающих сыграть с нами."
                    citizen1 "Надеюсь, ты передумаешь."
                    pass
            pass
    citizen1 "Да, тетя, ты нас сегодня очень порадовала! Скажу тебе по секрету, у меня небыло таких телок, как ты."
    mt "И не будет."
...
label cit1_2_counting1:
    citizen1 "Сыграем в считалочку! Тебе нужно встать в необходимую позу."
    menu:
        "Хорошо.":
            m "Хорошо."
            pass
