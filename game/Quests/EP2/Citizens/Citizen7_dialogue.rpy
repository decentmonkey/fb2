...
label cit7_naked_boobs_dance_1st:
    img 13508
    citizen7 "Я недавно представлял твою прекрасную грудь. Хочу тебя заверить, когда я на нее смотрю, у меня поднимается... Вдохновение."
    img 13509
    mt "Извращенец."
    img 13510
    ...
    img 13513
    m "Откуда я узнаю, что это даст тебе вдохновения?"
    img 13514
