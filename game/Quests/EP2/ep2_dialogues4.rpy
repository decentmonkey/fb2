...
label monica_office_cabinet_biff_dialogue1:
    ...
    call change_scene("monica_office_secretary") from _call_change_scene_97
    return False
    #Моника выходит
...
label monica_office_cabinet_biff_dialogue1a:
    ...
    if monicaKnowAboutKebabWork == True:
        ...
        "Или флаеры!!! Да!!!"
        call bitch(10, "monicaKnowAboutKebabWork_biff") from _call_bitch_175
    #
...
label monica_office_photostudio_melanie_dialogue1:
    ...
    menu:
        "Да, я примерно понимаю в чем заключаются они, твои силы...":
            call bitch(5, "monicaTalkedToMelanie1") from _call_bitch_176
            jump .local1
        "Мелани, ни один мужчина не устоит перед тобой!":
            call bitch(-5, "monicaTalkedToMelanie1") from _call_bitch_177
            jump .local2
...
#                    jump .local2
                "Уйти.":
                    call change_scene("monica_office_secretary") from _call_change_scene_98
                    return False
