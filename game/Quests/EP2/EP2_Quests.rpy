...
#    $ add_hook_day("dick_secretary_time_to_pay1", day = nextFriday, evening=True)
    ...
    call change_scene("dick_office_secretary") from _call_change_scene_151
    return
...
label monica_office_biff_talk_about_work1: #Моника разговаривает с Бифом второй раз, уже о работе.
    ...
    if _return == False:
        return False
    call change_scene("monica_office_secretary") from _call_change_scene_152
...
label monica_office_biff_talk_about_work2: #Моника разговаривает с Бифом третий раз.
    ...
    $ remove_hook()
    call change_scene("monica_office_secretary") from _call_change_scene_153
    return False
...
>>>>>>> Stashed changes
    ...
    call change_scene("rich_hotel_event_scene", "Fade_long", False) from _call_change_scene_154
    return
...
label monica_charity_event_talk1:
    ...
    call change_scene("rich_hotel_event_hall", "Fade_long", False) from _call_change_scene_155
    return
...
#    music Malicious
    ...
    call change_scene("rich_hotel_event_hall") from _call_change_scene_156
    return
...
label monica_charity_event_philip_talk1:
    ...
    music Lobby_Time
    call change_scene("rich_hotel_event_sittable", "Fade_long", False) from _call_change_scene_157
    return
...
label monica_charity_event_philip_talk2:
    ...
    call change_scene("rich_hotel_event_hall") from _call_change_scene_158
    return
...
#    $ hotelStaffOffended1 = False
    ...
    $ set_active("Teleport_Rich_Hotel_Tables", False, scene="rich_hotel_event_hall")
    if _return == False:
        call change_scene("rich_hotel_event_hall") from _call_change_scene_159
        return False
...
=======
    call change_scene("street_monica_office", "Fade_long") from _call_change_scene_160
>>>>>>> Stashed changes
    return
