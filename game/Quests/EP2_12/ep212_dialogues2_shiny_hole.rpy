...
label ep212_dialogues2_shiny_hole_1:
    ...
    mt "Без вских скидок от этого неудачника Джека!" # экстра
...
label ep212_dialogues2_shiny_hole_2:
    ...
    menu:
        "Притвориться шлюхой.":
            ...
            pass
        "Поставить на место этого идиота!": # увольнение с паба-?
    ...
    customer3 "Сказала всег два слова и уже заработала полтинник."
    ...
    customer3 "Не удивительно, что ты не можешь на нормальную работу устроиться..."
    customer3 "А зарабатываешь, показывая со сцены свою задницу..."
    mt "Вот сволочь!"
    ...
    m "Джо, ты говорил, что ничего подобного не будет происходить!" # Джо
    ...
    # Моника со злым лицом трется об клиента
    customer3 "Мммммм..."
...
label ep212_dialogues2_shiny_hole_3:
    ...
    customer3 "О! Хочу твою задницу снова заказать!"
    m "Это невозможно, я..."
