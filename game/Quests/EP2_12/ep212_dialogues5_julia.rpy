...
label ep212_dialogues5_julia_5:
    ...
    julia "Миссис Бакфетт..."
    julia "Мне это не снится?"
    m "Нет, милая."
    m "Если я буду жить здесь с тобой, оставив свой роскошный дом, ты мне поверишь?"
    # Юлия в шоке
    julia "!!!"
    julia "Вы шутите, Миссис Бакфетт?!"
    julia "Вы... Вы это сделаете ради меня?!"
    m "Конечно."
    julia "О, Миссис Бакфетт, я так рада!"
    # целовашки
    return
