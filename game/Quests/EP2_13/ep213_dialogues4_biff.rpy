...
label ep213_dialogues4_biff_8:
    ...
    biff "Еще одно слово, кукла безмозглая, вылетишь с работы!"
    ...
    mt "Биф действительно сделает эту мерзость - отдаст меня инвесторам?!"
    mt "?!?!?!"
    mt "Я не хочу это проверять на собственном опыте!"
    mt "Ненавижу их всех!"
    mt "!!!"
    ...
    investor4 "И Миссис Бакфетт это сегодня подтвердила."
    ...
    investor4 "Я инвестирую в журнал, если Миссис Бакфетт сейчас широко раздвинет ноги и сдвинет свои трусики."
    m "!!!"
