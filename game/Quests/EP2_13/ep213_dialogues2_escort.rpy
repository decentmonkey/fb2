...
label ep213_dialogues2_escort_1:
    ...
    mt "?!"
    mt "Я не могу больше терпеть... Мне нужно срочно пописать."
    ...
    # Моника оглядывается на другие столики
    # видит, что другие девочки на них заинтересованно смотрят и ехидно улыбаются
    # Моника
    m "..."
    mt "Я не пойму, эти сучки что, сговорились?"
    mt "Они что-то затеяли против МЕНЯ?!"
    mt "!!!"
    mt "И вообще!!"
    ...
    linda "Эта грубиянка пытается тут командовать!"
...
label ep213_dialogues2_escort_2:
    ...
    mt "Такие, как они, пачками ко мне на кастинги попасть мечтают!"
    mt "!!!"
    if monicaBitch == True:
        $ notif_monica()
        mt "Строят из себя непонятно кого, а на деле обычные серые мыши!!"
    ...
    waitress "Она Вас ждет там вместе с проститу... Кхм... С девочкой из эскорта..." # подозрительно
...
label ep213_dialogues2_escort_3:
    ...
    reception "Сделаешь хотя бы что-то не так, я даже разбираться не буду кто прав, кто виноват!"
    reception "Сразу же оштрафую тебя! Поняла?!"
    # Моника злобно
    m "Да!"
    mt "Сучка!"
    mt "Ненавижу!!!"
    reception "А теперь переодеваться и в номер!"
    reception "Быстро!!"
...
label ep213_dialogues2_escort_4:
    ...
    m "А как же... работа?"
    # Линда усмехается
    linda "Интим не предполагается."
    # осматривает Монику оценивающим взглядом
    linda "Такая как ты ему все равно не понравилась бы..."
    m "!!!"
...
label ep213_dialogues2_escort_5:
    ...
    mt "!!!!!"
    mt "Дьявол!"
    mt "Как же хорошо, что эта стерва выбрала мне костюм с маской!"
    ...
    investor3 "Я заберу тебя отсюда и никуда не отпущу от себя!"
    linda "..."
    investor3 "Мне больно сознавать тот факт, что любовь всей моей жизни вынуждена работать здесь."
    ...
    investor3 "Ты знаешь о том, что я являюсь ключевым инвестором одного модного журнала?"
...
label ep213_dialogues2_escort_6:
    ...
    investor3 "Дааа..."
    investor3 "Чувствуется, что ты опытная шлюшка..."
    ...
    m "!!!" # зло
    menu:
        "Врезать ему по яйцам!!! (увольнение)":
            # Моника злобно смотрит на него
            m "Я тебе не грязная шлюшка!"
            m "Ублюдок!"
            m "!!!"
    ...
    mt "Я себя чувствую грязной. Как-будто меня выпачкали в дерьме."
...
label ep213_dialogues2_escort_7:
    ...
    reception "Свой процент я уже вычла."
    $ add_money(350.0)
...
label ep213_dialogues2_escort_9:
    ...
    girl_1 "Хи-хи-хи..."
    girl_1 "Линда, ты меня опередила."
    girl_1 "Я хотела, чтбы она отлизала у меня."
