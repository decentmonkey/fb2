...
label ep213_dialogues_police1:
    ...
    detective "Знаю, ты удивлен тем, что я сопровождаю заключенную."
    detective "Однако, я это делаю, чтобы сказать тебе замечание."
    overseer "Замечание?"
    detective "Кхм... Миссис Бакфетт."
    detective "Вы можете не отвлекаться на наш разговор."
    detective "Обычно, сотрудники должны проследить за тем, чтобы вы переоделись в "
