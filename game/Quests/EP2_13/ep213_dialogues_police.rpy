...
# ложатся спать отдельно
    ...
    menu:
        ...
        "Поставить его на место!":
            ...
            m "И, если он узнает про то что здесь происходит, он отправит тебя в такое место, где ты будешь молить о конце своей жалкой никчемной жизни!"
    ...
    menu:
        "Попросить у заключенного разрешение показать свою грудь.":
            pass
        "Поставить его на место!":
            return False
    ...
    m "Я..."
    m "Я прошу разрешение показать свою грудь..."

    prisoner1 "Сиськи! Показать сиськи!"
    prisoner1 "Скажи кто ты и скажи свою просьбу правильно!"

    menu:
        "Сказать что Моника шлюха и попросить у заключенного разрешение показать свои сиськи.":
            pass
        "Поставить его на место!":
            return False

    m "Я... Я хорошая шлюха..."
    m "И я прошу разрешение..."
    m "Показать... Показать свои..."
    prisoner1 "!!!"
    m "Я прошу разрешение показать свои сиськи..."
...
# Моника подходит к решетке нормально
    ...
    mt "Мне надо вставить ее обратно в себя..."
