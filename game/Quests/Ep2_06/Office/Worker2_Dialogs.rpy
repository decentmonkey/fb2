...
label worker2_dialogue_workplace:
    mt "По-моему, он разбирается в компьютерах... Но я в них ничего не понимаю..."
    mt "Может стоит спросить его о чем-то?"
    menu:
        "Задать умный вопрос.":
...
label worker2_dialogue_office:
    ...
    menu:
        "Разве тебя не учили стучаться?":
            ...
            m "Да, заходи."
            m "Вот видишь, все просто. Ты гоовришь, что у тебя все работает..."
