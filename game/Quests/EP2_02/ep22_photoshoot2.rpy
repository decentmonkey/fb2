...
label ep22_photoshoot2_end:
    ...
    menu:
        "Переодеться назад...":
            ...
            return
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if biffMonicaCastingsEnabled == True and corruption >= photoshoot2_casting_corruption_required : #если есть кастинги
