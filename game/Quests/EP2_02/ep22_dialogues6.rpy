...
label ep22_dialogue6_3:
    ...
    menu:
        ...
        "Уйти.":
            return False
    music Groove2_85
    if ep22_quests_monica_presentation_completed == True and math.floor((day+1)/7) > math.floor((ep22_quests_monica_presentation_completed_day+1)/7) and (len(list(set(PS8_shoots_array))) >= 24 or photoshoot8_nude_completed == True):
