...
label ep210_dialogues5_julia_1:
    ...
    menu:
        "Подыграть Юлии.":
            pass
        "Как она могла про такое подумать?!":
            m "Юлия!!!"
    ...
    julia "Вы такая красивая и умная. Как я могу вам нравится?"
...
label ep210_dialogues5_julia_3_2:
    ...
    mt "Как такая, как она, может понравиться такое леди, как Я?!"
    return
...
label ep210_dialogues5_julia_3:
    ...
    julia "Я читала в одной книжке..."
    julia "Что начальница каждый день целовала свою подчиненную... Говорила ей комплименты."
    # еще больше смущаясь
