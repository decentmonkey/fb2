...
label ep210_dialogues1_office_biff_4:
    ...
    secretary "Мистер Биф, я принесла костюм, о котором Вы говорили."
    biff "Ага. Отдай его этой цыпочке!" # улыбается, смотрит на Монику
    ...
    mt "???"
    m "Что это значит? Что еще за костюм?"
    # Бифф мерзко улыбается
    biff "Цыпочка не просто проведет презентацию..."
    biff "Она еще и повеселит меня, чтоб мне не было скучно!"
    mt "Что на этот раз?!"
    biff "Давай, кукла, переодевайся быстрее!"
    m "Что, прямо здесь?"
    biff "Да-да! Шевели своим задом быстрее!"
    # Моника надевает на себя костюм с открытым задом, начинает возмущаться
    m "ЧТО ЭТО?!"
    ...
    # Моника возмущенно
    m "Это наряд для какой-нибудь дешевой шлюхи в дешевом баре! Я не собираюсь это надевать!"
    ...
    m "!!!"
    biff "Если откажешься проводить презентацию в этом костюме..."
    ...
    mt "Только не он!!! Я поклялась, что расквитаюсь с этим мерзавцем!" # если была сцена в туалете с ним
    mt "И я не буду Моникой Бакфетт, если я не сделаю этого!!!"
    mt "Это не тот мерзкий тип, который предлагал мне всякие гадости на вечере в отеле?" # если не было сцена в туалете
    ...
    mt "!!!"
    # Моника обращается к присутствующим
    ...
    m "И сейчас, когда в СМИ пошел слух про смену курса журнала... Продажи и интерес со стороны публики только возрос."
    ...
    m "Поэтому наша компания уверена в дальнейшем росте!"
    m "..."
    # инвесторы смотрят на нее, как на дуру
    m "Сейчас, в подтверждение моих слов, мы продемонстрируем вам график роста наших продаж..."
    mt "!!!" # снова зло на Бифа
    # график на экране меняется на корявый, нарисованный от руки. Моника оглядывается на экран, не поворачиваясь
    mt "!!!"
    mt "ИДИОТ!" # на Бифа
    m "..."
    ...
    m "..."
    # приседает и поднимает его, при этом разглядывает Монику
    # если она при этом стоит лицом к нему, он все все равно замечает ее голый зад и рассматривает
    ...
    mt "Эти никчемные жадные неудачники еще и вопросы мне задают!!!"
    ...
    m "Я сейчас скажу секретарю, и она принесет вам все необходимые документы."
    ...
    # улыбка Моники тает
    m "Кто он вообще такой, чтоб так со мной разговаривать!!!"
    ...
    mt "Ненавижу его!!!"
    mt "!!!"
    mt "И как мне теперь выйти отсюда?!"
    # проходит боком, сложив руки сзади на попе, улыбается присутствующим
...
label ep210_dialogues1_office_biff_5:
    # Моника стоит в приемной
    mt "Надо скорее снять с себя этот ужасный костюм!!!"
    mt "Ненавижу сволочь Биффа!"
    ...
    mt "!!!"
    # из кабинета выходит Биф, Моника смотрит на него недовольно, сложив руки
    ...
    biff "Если бы цыпочка носила этот костюм на работе в офисе!"
    ...
    # Моника смотрит на него с ненавистью, он возвращается обратно к себе в кабинет
    return
