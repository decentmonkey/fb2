...
label ep210_dialogues7_escort_hotel_12:
    # Моника стоит в кафе, оглядывается. - добавить 2 девушек и их реплики на повседневные темы; потом одна ссорится с парнем и уходит
    ...
    # кадр меняется. Моника за столом, помимо нее и клиента сидят другие люди, Моника пытаетя доминировать над клиентом, говорит что-то подать ей и т.п.
    ...
    menu:
        "Уйти!":
            ...
            m "!!!"
            # Моника зло на него смотрит и уходит- выговор
            return False
        "Ударить мерзавца и уйти!":
            ...
            m "!!!"
            # Моника зло на него смотрит и уходит -увольнение
            return False
