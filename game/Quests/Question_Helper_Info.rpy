...
label questHelp_init:
    ...
    $ questHelpDataQuests = {
        ...
        # ФОТОСЕССИИ
        "photoshoot_1" : [t_("ФОТОСЕССИИ"), t_("Провести первую фотосессию"), t_("Пойти в фотостудию и поговорить с Алексом.")],
        ...
        # открываем victoria_1
        # dick_desc4 -> dick_desc5, victoria_desc1
        ...
        # ФИТНЕС
        "fitness_1" : [t_("ФИТНЕС"), t_("Пойти с Бетти на фитнес"), t_("При достижении уровня отношений с Бетти 3.")],
        #
        #
        #
        #
    ...
    $ questHelpDataCategoriesDescriptions = [   # по максимуму использовать фразы из квест-лога!!
        ...
        ["dick_desc5", t_("ДИК АДВОКАТ"), t_("Теперь я должна приносить Виктории раз в неделю $ 5000 до пятницы. Я даже не представляла насколько она опасна.")],
