...
label questLog_init:
    ...
    [67, _("Биф требует, чтобы я убедила этих глупых инвесторов инвестировать деньги в мой журнал. Как он предполагает я смогу это сделать?"), True, _("Офис")],
    [68, _("Я не собираюсь быть позорищем для всего мира! Я верну себе мою компанию, но не таким путем!"), True, _("Офис")],

    [64, _("Мне нужно каждый день целовать Юлию и говорить ей комплименты."), True, _("Офис")],
    [63, _("Я решила подыграть этой никчемной Юлии. Отличный способ узнать цвет ее трусиков."), True, _("Офис")],
    ...
    [71, _("У меня теперь есть место, где я могу жить. Апартаменты в трущобах... Но это лучше, чем подвал в доме, где живет семейка идиотов."), True, _("Жизнь")],
    [62, _("Мне предложили работу в эскорте! Неужели я решусь на такое?! Хотя... Там можно неплохо заработать."), True, _("Жизнь")],
    [61, _("У меня появилась возможность дополнительного заработка по субботам. У Филиппа. Но смогу ли я?"), True, _("Жизнь")],
    ...
    [69, _("Я не собираюсь вилять голой попой перед посетителями этой дыры!!!"), True, _("Shiny Hole")],

    [66, _("Из-за это рыжей сучки я теперь должна отдавать все свои чаевые Эшли! Ненавижу ее!!!"), True, _("Shiny Hole")],
    ...
    [70, _("Эшли хочет чтобы я помирилась с этой сучкой Молли. Не представляю как это возможно!"), True, _("Shiny Hole")],
    ...
    [65, _("Фред обычно во дворе у машины..."), True, _("Жизнь")]
    ]
