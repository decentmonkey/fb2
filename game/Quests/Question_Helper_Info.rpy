...
label questHelp_init:
    ...
    $ questHelpDataQuests = {
        ...
        "house_3" : [t_("ДОМ"), t_("Барди хочет увидеть трусики Моники"), t_("Разговаривать с Барди во время каждой уборки. Уровень отношений с Барди при этом увеличивается.")], # вторая уборка и разговор - прогресс Барди перешел на ур 2
        ...
        # при отказе разносить флаеры - стоп для work_slums_2
        "work_slums_2" : [t_("РАБОТА НА УЛИЦЕ"), t_("Согласиться разносить флаеры"), t_("Подходить к разным прохожим. Всего нужно раздать 5 флаеров, иначе Моника получит всего пол кебаба.")],
