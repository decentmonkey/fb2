...
# Я как-то не задумывалась что скажу этому человеку, О БОЖЕ!!!
    ...
    m "Вы знаете, мне довольно сложно вести честный образ жизни, не имя документов и..."
    ...
    marcus "Я действительно осознаю все те нудобства, с которыми Вам приходится сталкиваться."
    ...
    marcus "Но вернемся к Вашей жизни все этих стен."
    marcus "А как же еда?"
    ...
    m "Но, если об этом просит такой мужчина как Вы, то никакая леди не сможет отказать в этом..."
