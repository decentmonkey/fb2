...
label ep28_dialogues6_julia_1:
    ...
    fred "С моей стороны было бы непрофессионально совмещать две работы, мисс Бакфетт."
    fred "Тем более, такие не схожие по должностным обязанностям."
    # Фред делает паузу и добавляет с улыбочкой
    fred "Чего я не могу сказать о вас, мисс Бакфетт..."
    # Моника злится
    mt "!!!"
    mt "Я готова придушить эту сволочь Фреда!!!"
    mt "Чего он ко мне пристал со своими нелепыми заданиями?!"
    fred "Мне очень понравилось, мисс Бакфетт, как вы справились с заданием в прошлый раз."
    ...
    fred "Если вы, мисс Бакфетт, откажетесь играть в мою небольшую профессиональную игру..."
    fred "То вы быстро перестанете быть боссом..."
    # Моника зло смотрит на Фреда и молчит
    m "!!!"
    fred "Теперь вы, мисс Бакфетт, должны выяснить, какого цвета трусики носит Юлия."
### Какого цвета трусики носит Юлия (т.е. вообще, не именно сегодня, т.к. она носит одни и те же в игре) +
    ...
    m "???"
    fred "Я не сомневаюсь, мисс Бакфетт, что у вас все получится."
    ...
    # Фред ухмыляется
    fred "До скорой встречи, мисс Бакфетт."
    m "..." # зло
    # Фред уходит
...
label ep28_dialogues6_julia_2:
    ...
    mt "Скорее бы вернуть себе все, что у меня отняли! Первым делом я уволю этого 'профессионала'!"
    mt "!!!"
    ...
    julia "Мисс Бакфетт, под вашим столом нет флешки..."
    m "..."
    mt "Конечно, ее там нет!.."
    m "Юлия, ты уверена, что внимательно посмотрела?" # строго
    # Юлия неуверенно
    julia "М-м-мисс Бакфетт, я сейчас посмотрю еще раз..."
    ...
    julia "Мисс Бакфетт... Что в-в-вы д-делаете?"  # вопросительно смотрит на Монику
    m "..." # растерянно
    m "Ничего!"
    m "..."
    m "Ты нашла флешку?!" # строго
    # Юлия встает, с непонимающим видом
    julia "Да, мисс Бакфетт... Она лежит у вас на столе."
    julia "..."
    m "..."
...
### В итоге, Юлия ничего не находит +
    ...
    julia "Мисс Бакфетт, здесь нет никаких документов..."
    m "..."
    ...
    julia "Нет, мисс Бакфетт... На полке нет ничего."
    julia "..."
    m "..."
...
label ep28_dialogues6_julia_4:
    ...
    fred "Мисс Бакфетт... Это непрофессионально с вашей стороны не выполнять условия нашей договоренности..."
    ...
    # Моника смотрит на Фреда с негодованием
    mt "Ненавижу этого мерзавца!"
    fred "Вы так и не сделали, что я вам сказал, мисс Бакфетт?"
    # Моника убийственно смотрит на него, но молчит
    m "..."
    # Фред с улыбочкой
    fred "Так уж и быть, мисс Бакфетт. Я готов подождать еще немного..."
    m "..."
    fred "Я не сомневаюсь, что у вас все получится, мисс Бакфетт."
    fred "Я с нетерпением буду ждать вашего ответа."
    fred "До скорой встречи, мисс Бакфетт."
    return
...
label ep28_dialogues6_julia_5:
    ...
    julia "Мисс Бакфетт! Что вы делаете?!"
    m "Ничего!"
    m "Сиди и работай!"
    m "И не отвлекайся!"
    julia "М-м-мисс Бакфетт... Вы что-то потеряли? Вам помочь?" # растерянно
    ...
    julia "Мисс Бакфетт! Мне кажется или вы пытаетесь... Вы..."
    julia "!!!"
...
### Нет понятия "последний день". Фред говорит просто поторопиться. (не привязываемся к таймингу) +
    ...
    # Фред ей отвечает спокойно
    fred "Мисс Бакфетт... Вы выяснили то, о чем я вас просил?"
    m "!!!" # зло смотрит на него
    mt "Ненавижу этого мерзавца!"
    ...
    # Фред с улыбочкой
    fred "Мисс Бакфетт, я все понимаю. Но прошу вас поторопиться."
    ...
    fred "Не вижу в этом проблемы, мисс Бакфетт."
    fred "Просто наденьте трусики Юлии..."
    m "???" # как на идиота
    fred "Вы же любите их носить, мисс Бакфетт?"
...
label ep28_dialogues6_julia_7:
    ...
    mt "..."
    m "Юлия!"
    julia "Да, Мисс Бакфетт?" # вопросительно
    m "..."
    menu:
    ...
    julia "Это правда, мисс Бакфетт?.."
    m "Да, Юлия..."
    julia "А я думала, что... Вы... В общем..."
    m "Мне правда все нравилось. Думаю, лучше чем ты, не найду."
    ...
    # Юлия, смутившись
    julia "Если быть честной, мисс Бакфетт, то я... Я сомневаюсь, что это так..."
    ...
    julia "Мисс Бакфетт... Это мои трусики..."
    julia "Я узнаю их!"
    # Моника стыдится
    mt "Боже! Какая глупая ситуация!"
    mt "И как теперь выкрутиться из нее?"
    mt "..."
    m "Но ведь правда они красивые?" # сквозь зубы
    julia "Вообще-то, мисс Бакфетт, они ужасные. Я ненавидела носить их."
    ...
    # Юлия офигевает
    julia "Что???"
    julia "Нет! Я не буду вам ничего показывать, мисс Бакфетт!"
    # Моника требовательно
    m "Юлия, просто покажи мне их и все. Я просто хочу посмотреть."
    julia "Нет, мисс Бакфетт! Я вам ничего не покажу!"
...
label ep28_dialogues6_julia_8:
    ...
    m "..."
    # Фред с улыбочкой
    fred "Мисс Бакфетт, обман - это непрофессионально."
