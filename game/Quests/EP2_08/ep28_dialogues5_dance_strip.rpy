...
label dialogue_5_dance_strip_19:
    ...
    mt "!!!"
    $ log1 = _("Эшли простила мне долг. Теперь я могу зарабатывать, выступая на сцене в пабе Shiny Hole.")
    return
...
# Разговор с Эшли после первого выступления по желанию.
label dialogue_5_dance_strip_21:
    ...
    if pubMonicaWaitressTips == 0:
        ...
        if tipsBack == 0.0:
            $ tipsBack = 0.05
        $ add_money(tipsBack)
        ashley "Хорошо. Вот твои 70 процентов."
...
# Паб. Моника выходит из гримерки после выступления на сцене по желанию. Если идет в сторону барной стойки, появляется Джо.
...
label dialogue_5_dance_strip_24:
    ...
    joe "Он хочет, чтобы ты танцевала для него..."
    ...
    mt "Для которого лучшее развлечение в жизни - прийти в эту дыру и выпить пива?!"
    mt "!!!"
    mt "Ни за какие деньги не стану этого делать!!!"
