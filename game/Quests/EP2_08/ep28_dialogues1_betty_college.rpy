...
label dialogue_betty_college_0_1:
    ...
    menu:
        ...
        "Убежать.":
            m "Я хорошая гувернантка! Но я не буду этого делать!"
            return False
    # Моника, скрипя зубами соглашается, поднимает юбку, Барди фото не делает и смотрит на Бетти
...
# Дом. Бывшая спальня Моники. Разговор Барди и Бетти.
...
label dialogue_betty_teacher_1:
    ...
    # тут Бетти случайно роняет папку Барди на пол
    betty "Oй!"
