...
label ep217_dialogues6_office_6:
    ...
    # админша видит Стива и очень удивляется
    ...
    # но он демонстративно встает и отходит в сторону админши
    ...
    reception "Это наша новенькая..."
    reception "У нее первый рабочий день..."
    #
    $ notif(_("Администратор подозревает, что Моника работает с клиентами в обход ВИП-эскорта."))
    #
    #
    ...
    # если не работала никогда в эскорте
    #
    $ notif(_("Моника не имеет отношения к ВИП-эскорту."))
    #
    m "Я?! Я должна что делать?!"
    m "С чего ты это взял?!"
    philip "Не стоит притворяться, Миссис Бакфетт."
    philip "Вы не очень хорошая актриса..."
    philip "Хотите, чтобы все присуствующие здесь узнали о том, что вы тут работаете?"
    #
    m "!!!"
