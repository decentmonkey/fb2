...
#    if monica_philip_visits > 1:    #############проставить if
    img 32998
...
#    if monicaBiffInvestorsLeGrand3 == day:         #############проставить if
    img 33002
...
#    if monicaHotelAdminAgreement3 == True:         #############проставить if
...
#    if monicaMelanieCastingLickedDildo == True:   #############проставить if
    #
