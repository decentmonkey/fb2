...
label ep217_dialogues5_phillip_2:
    ...
    m "Отработать?!"
    m "?!"
    philip "Да, Миссис Бакфетт, вы сейчас залезете на это..." # показывает рукой на штуку, где будет пялить Монику
    ...
    philip "Оно может ползти в клетку и ждать Мастера."
    ...
    m "..."
    philip "Она заработает $ 10 000 в неделю."
    m "Десять тысяч?!"
    m "?!"
    ...
    mt "..."
    menu:
        "Согласиться.": # пункт будет неактивным
            return
        "Отказаться!":
...
label ep217_dialogues5_phillip_3:
    ...
    mt "И он думает, что я могу согласиться стать на неделю его рабой?!"
