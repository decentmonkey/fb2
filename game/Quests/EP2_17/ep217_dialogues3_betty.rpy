...
label ep217_dialogues3_betty_2:
    ...
    betty_t "Мне еще Ральфу обед нужно приготовить..."
    ...
    liam "Оооо, еще!!"
    # получится показать, что через окно на них смотрит Фред и улыбается -?
    ...
    fred "Уверен, Лиам не против того, чтобы я тоже немного поработал..."
    ...
    fred "Она и сейчас живет в этом доме..."
    fred "Но уже в несколько иной роли."
    fred "Правила игры изменились и теперь хозяйка в доме Миссис Робертс."
    # указывает на голую Бетти в отключке
    # сосед смотрит на нее задумчиво
    liam "Говоришь, правила игры поменялись?.."
    # затемнение
    return
