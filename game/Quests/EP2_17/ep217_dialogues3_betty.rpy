...
label ep217_dialogues3_betty_2:
    ...
    fred "Вы ведь не откажете ему в этой небольшой просьбе, Мистер Робертс?"
    liam "Да, Мэм! Погладить брюки, например..."
    # Бетти косится на соседа, а потом смущенно опускает глаза, убирая руку от утюга
