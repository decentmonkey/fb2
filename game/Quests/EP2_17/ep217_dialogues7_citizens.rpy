...
label ep217_dialogues7_citizens_1:
    ...
    mt "Придурки!!!"
    mt "Кретины!!!"
    citizen9 "Поэтому я хочу арендовать твою сутенерскую квартирку!"
    ...
    mt "Утонченая леди вынуждена раскуривать косяк!"
    ...
    menu:
        "Предложить косяк Найджела в качестве оплаты":
            ...
            m "Я могу отблагодарить тебя по-другому!"
