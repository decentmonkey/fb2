...
label ep217_dialogues7_citizens_1:
    ...
    # Очухивается Найджел и говорит эй йо! кореш! ты меня придавил
    # слезай с меня, я не могу дышать!
    # Моника что, он жив?!
    # Найджел встает, спасатель продолжает лежать
    # Общаются с Найджелом. Тот спрашивает а кто это
    # Говорит вот это дурь, это, наверное, лежит мой косяк
    # бла бла бла
    # Моника в итоге говорит что это... это.. неважно
    # Думает не скажу же я ему что это тот, кто должен был избавиться от его тела
    # И что он тепер, умер?
    # Что, мне просить этого укуренного придурка изабвиться теперь от него?
    # Хотя... Наджел же жив
    # Может быть и этот... Член!
    # У него стоит член! Этот урод жив!
    # Моника наступает каблуком на его член (меню)
    # Или Схватить за член рукой.
    #  Если хватает, то он очухивается лайтово
    # Если наступает, то орет и вскакивает убегает
    # Она их прогоняет 
