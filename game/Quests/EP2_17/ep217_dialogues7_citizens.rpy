default monicaCitizens9Slums1 = False # Моника согласилась сдать апартаменты в аренду для курения Найджелу
default monicaCitizens9Slums2 = False # Моника согласилась на минет и косяк
default monicaCitizens9Slums3 = False # Моника предложила Филу косяк Найджела
default monicaCitizens9Slums4 = False # Моника согласилась на секс с Филом

default monicaCitizens5Slums1 = False # Моника согласилась пойти Акирой саном в свои апартаменты
default monicaCitizens5Slums2 = False # Моника согласилась, чтобы Акира нацепил зажимы на ее грудь
default monicaCitizens5Slums3 = False # Моника согласилась, чтобы Акира нацепил зажимы на ее киску
...
label ep217_dialogues7_citizens_1:
    ...
    menu:
        "Согласиться.":
            ...
            $ monicaCitizens9Slums1 = True # Моника согласилась сдать апартаменты в аренду для курения Найджелу
            pass
    ...
    menu:
        ...
        "Видимо этот укуренный кретин не отстанет от меня...":
            $ monicaCitizens9Slums2 = True # Моника согласилась на минет и косяк
            pass
    # Моника зло на него смотрит
    ...
    citizen9 "У тебя нет шансов, Найджел никогда не проигрывает дуэль на дури, ха-ха!"
    $ add_money(30.0)
    ...
    menu:
        ...
        "Попытаться тянуть время.":
            ...
            mt "Может быть сделать это просто руками..."
    ...
    menu:
        "Предложить косяк Найджела в качестве оплаты":
            $ monicaCitizens9Slums3 = True # Моника предложила Филу косяк Найджела
        ...
        "Согласиться на секс в качестве оплаты за помощь":
            $ monicaCitizens9Slums4 = True # Моника согласилась на секс с Филом
...
#                ""
            ...
            # Найджел открывает глаза, лежа на полу, голова вниз
            # Смотрит в пол глазами в упор
            # думает про себя вот меня вштырило, вот это дурь!
            # что это у меня перед глазами?
            # какие-то полосы...
            # черная, коричневая...
            # еще какие-то паутинки...
            # это такой глюк?
            # круто, вау!
            ...
            # когда вставил, Найджел встает и сзади стоит смотрит на то как Монику жарят
            ...
            # найджел говорит что круто вы жаритесь
            # а как же я?
            # теперь моя очередь!
    ...
    mt "ОНИ ОЖИЛИ!!!"
    mt "!!!"
    # Найджел скидывает с себя Фила, отталкивая
    # тот скатывается с него, падает на пол на живот, на член
    citizen6 "АААА!!!"
    citizen6 "Твою мать!!!"
    citizen6 "Мой член!!!"
    # оба садятся на полу
    ...
    citizen9 "Чувакииии! Вот это меня вырубило! Йоу!"
    # Найджел смотрит на косяк, потом на Фила
    # говорит с наездом, указывая рукой на него
    citizen9 "Эй, ты! Ты курил мой косяк?!"
    # Фил подскакивает, одной рукой грозит Найджелу, а другой держится за член
    citizen6 "Да пошел ты!"
    citizen6 "Я из-за тебя чуть не сломан свой член!"
    ...
    mt "О Боги!"
    mt "Никогда бы не подумала, что буду радоваться..."
    mt "Что эти никчемные животные живые!"
    mt "Уф! Какой-то кошмар!"
    mt "Как ты могла попасть в такую ужасную ситуацию, Моника?!"
    mt "!!!"
    # Моника офигевшая смотрит на Джека, он говорит ей
    shawarma "Если Мадаме передумать съезжать..."
    shawarma "Джек с радостью и дальше будет сдавать ей свой шикарный апрартамент!"
    shawarma "Только больше никакой дурь в мой апрартамент!"
    m "Д-да..."
    m "Я пока поживу тут... Еще немного..."
    # Джек уходит (а может вставить сюда 2-й секс с Джеком, который написан про 20-ти процентную скидку?)
...
label ep217_dialogues7_citizens_2:
    ...
    menu:
        "Согласиться.":
            ...
            if slumsApartmentsRentActive == False:
                ...
                return False
            # если арендует квартиру у Джека
            $ monicaCitizens5Slums1 = True # Моника согласилась пойти Акирой саном в свои апартаменты
            pass
        "Отказаться.":
    ...
    menu:
        "НЕТ!!!":
            ...
            pass
        "Согласиться.":
            $ monicaCitizens5Slums2 = True # Моника согласилась, чтобы Акира нацепил зажимы на ее грудь
            mt "Черт!"
            mt "$ 10!"
            mt "Мне нужны деньги..."
            mt "..."
                ...
                "Согласиться.":
                    ...
                    menu:
                        "НЕТ!!!":
                            ...
                            pass
                        "Согласиться.":
                            $ monicaCitizens5Slums3 = True # Моника согласилась, чтобы Акира нацепил зажимы на ее киску
                            mt "Моника, соберись!"
