...
label ep22_4_dialogues2_fitness_1:
    ...
    victoria "Кстати, ты, подружка, отлично справилась с выполнением мойе просьбы..."
    victoria "На той вечеринке, когда Стефани была у тебя в гостях."
    victoria "Скоро Стефани станет моей лучшей подружкой. Хи-хи-хи!"
    melanie "..."
    victoria "Я знаю, что ты не будешь ревновать меня к ней."
    victoria "Ты эе хорошая подружка?"
...
label ep22_4_dialogues2_fitness_2:
    ...
    melanie "Да... Очень..."
    victoria "Я, как твоя лучшая подружка, тебе посоветовала самы лучший вариант."
    melanie "Да, подружка."
    ...
    victoria "Еще немного и мы с подружкой Мелани станем спортиными и подтянутыми, как вы, девочки!"
