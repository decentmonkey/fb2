...
# Моника после обычного рабочего дня отдает чаевые Эшли перед уходом
## Моника перед выходом на сцену, а Молли уже уходит
label ep215_dialogues1_pub_1:
    # после того, как Моника отдает деньги Эшли
    # к ним подходит Молли, она в одежде
    ...
    ashley "А ты уже выполнила свои королевские обязанности?"
    molly ""
...
label ep215_dialogues1_pub_6:
    ...
    customers2 "Да, рыжая королева! Поркути жопой! Вот так! ДАААА!" # танцует Молли
...
label ep215_dialogues1_pub_7:
    ...
    mt "Эта сучка при каждом удобном случае подставлет меня перед Эшли!"
...
label ep215_dialogues1_pub_9:
    ...
    menu:
        "Проигнорировать рыжую шлюху!":
            ...
            mt "И вообще, Моника!"
            mt "Тебе не стоит опускаться до уровня этой тупой деревенщины, которая возомнила из себя королеву!"
    ...
    m "МЕРЗКАЯ СУКА!!!"
    molly "АХ ТЫ ДРЯНЬ!!!"
    # Молли тоже вцепляется в волосы Моники
    m "НЕНАВИЖУ!!!"
    m "УБЬЮ ТЕБЯ!!!"
    ...
    # потом Молли ставит Монике подножку и они обе падают на Эшли, и потом все вместе на пол
    m "АААААА!!!"
    molly "ТВААААРЬ!!!"
    ...
    # Молли отталкивает Монику, но та садится на нее сверху и хватает за шею
    m "АААААА!!!"
...
label ep215_dialogues1_pub_10:
    ...
    molly "!!!"
    # Молли сидит на сцене голая, полулежа, смотрит на Монику снизу вверх, как поверженный враг
    return

# Показываем картину с Моникой (королева shiny hole)
...
label ep215_dialogues1_pub_11:
    ...
    molly "Я тебе этого просто так не оставлю!"
    ...
    mt "В отличие от рыжеволосой шлюхи! Хи-хи-хи!"
    mt "Так и надо этой сучке! Пусть знает свое место!"
    mt "Здесь Я королева, а она НИКТО! Пустое место!"
    $ log1 = _("Теперь корона Shiny Hole принадлежит МНЕ! Я буду пользоваться королевскими привилегиями! А эта сучка Молли теперь никто! Хи-хи-хи!") # квест-лог
    return
...
label ep215_dialogues1_pub_13:
    ...
    clare "Моника, привет!"
    clare "Слышала о твоем триумфе! Поздравляю!"
    m "Привет, Клэр!"
...
label ep215_dialogues1_pub_14:
    ...
    mt "Извращенка!"
    mt "Надо будет узнать у нее, что это за обязанности..."
    mt "Я сделаю это позже. А пока я буду наслаждаться своими королевскими привилегиями!"
