...
label ep215_dialogues1_pub_9:
    ...
    # потом Молли ставит Монике подножку и они обе падают на Эшли, и потом все вместе на пол (Моника падая хватается за что-нибудь, это оказываются трусы Эшли, она их стягивает)
    m "АААААА!!!"
    molly "ТВААААРЬ!!!"
