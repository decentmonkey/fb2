...
label ep215_dialogues3_escort_10:
    ...
    # Олаф заходит в лифт
    if monicaHotelAdminAgreement3 == True:
        # Линда подходит к Монике и зло ей говорит
...
label ep215_dialogues3_escort_11:
    ...
    m "Поэтому к любому вину, дешевле $ 5000 за бутылку, я даже не стану притрагиваться..."
    ...
    # если Моника не работает и не работала в эскорте, то jump на лейбл ep215_dialogues3_escort_ (Линда приносит вино)
    return

# служебный коридор отеля
label ep215_dialogues3_escort_12:
    # Моника заходит в коридор отеля, администратор ее там ждет
     и общаются на предмет того, что это клиент
