...
label ep215_dialogues3_escort_10:
    ...
    if monicaHotelAdminAgreement3 == True:
        ...
        mt "А эта сучка почему не на своем рабочем месте!"
        mt "Ненавижу ее!"
...
label ep215_dialogues3_escort_11:
    ...
    m "Вы ее знаете?"
    olaf "Это... Это постоянная гостья этого отеля..."
    olaf "Кхм... Я с нею пару раз виделся тут, когда останавливался в номере..."
    olaf "Не обращайте внимания, Миссис Бакфетт."
    olaf "Эта девушка меня не интересует."
    olaf "Могу я предложивть Вам вина?"
    ...
    olaf "Здравствуйте."
    olaf "У вас имеется вино Montrachet Grand 2007 года?"
    olaf "..."
...
label ep215_dialogues3_escort_12:
    ...
    if monicaHotelAdminAgreement3 == True and ep212_escort_monica_fired == False:
        ...
        m "!!!"
        reception "Ты сама мне признавалась в этом!!!"
        #
    ...
    if ep212_escort_monica_fired == True:
        ...
        mt "Черт!!!"
        mt "!!!"
        reception "Ты решила, что можешь водить в этот отель клиентов и зарабатывать на них?!"
        reception "Или ты думала, что у тебя получится сделать это незаметно?!"
        reception "И не платить проценты, причитающиеся ВИП-эскорту?!"
        mt "Что за бред она несет?!"
        mt "?!"
        m "Вообще-то, этот мужчина - мой хороший знакомый!"
        m "Я что, не имею права провести вечер со своим другом?!"
        reception "Не ври мне, [monica_hotel_name]!!"
        reception "Я знаю этого мужчину!"
        reception "Он постоянный клиент Линды!"
        ...
        m "!!!"
        reception "Он твой клиент, [monica_hotel_name]!!!"
        reception "И теперь ты должна за него процент ВИП-эскорту!!!"
        reception "За то, что обслуживаешь этого клиента в нашем отеле!!!"
        reception "И если будешь спорить с этим, я вызову охрану отеля!!!"
        reception "Они с тобой разберутся и выпишут тебе штраф!!!"
        reception "Или вообще сдадут тебя полиции, мошенница!!!"
        # Моника в шоке
        m "ЧТОООО?!"
        m "Какой еще процент?!"
        m "Я с ним встречаюсь не за деньги!!!"
        ...
        #
        mt "!!!"
        m "Я не получаю от этого мужчины никаких денег!"
        m "И вообще-то, он уже заплатил за свой номер!"
        reception "Все, хватит!"
        reception "Ты должна $ 450 за работу с этим клиентом!"
        reception "Это доля ВИП-эскорта!"
...
########## отсюда повтор сцены разговора и секса в следующем if'е
        label ep215_dialogues3_escort_14a:
        ...
        m "???"
        # он протягивает руку и проводит по ноге (или попе) Моники
        ...
        menu:
            "Черт! У меня кончились доводы...":
                pass
        # Олаф мнет ее грудь, потом целует
        mt "Фу! Как это все омерзительно!"
        mt "Ненавижу! Ненавижу!"
        mt "!!!"
        # Олаф отстраняется от ее груди и наклоняется над ее лицом, тянется губами за ее поцелуем
        # поцелуй
        olaf "Я не могу поверить в происходящее..."
        olaf "В моей постели..."
        olaf "Сама Миссис Бакфетт..."
        # он тянется к ее брюкам и приспускает их немного, оголяя живот
        # целует
        ...
        mt "Из-за дурацки приказов сволочи Бифа!!!"
        mt "Бесит!!!"
        mt "!!!"
        ...
        olaf "Думаю, Вы не возражаете, если я..."
    ...
    # Если уволена, приход Линды в номер, просто вино
    if ep212_escort_monica_fired == True:
        # Линда подходит с бутылкой вина (подносом) к столику
        # бросает недовольные взгляды на Монику
        mt "Какого черта эта дрянь так на меня смотрит?!"
        mt "Я уже не работаю в их гребаном эскорте!"
        #
        ...
        olaf "Молчи, я сказал!"
        olaf "Я тебе потом все расскажу!"
        linda "Но Олаф!"
        olaf "Все!"
        olaf "Иди!"
        ...
        olaf "Жаль..."
        olaf "Тогда поеду один. И куплю себе водки!"
        m "Олаф, не забудьте оставить $ 1 000 на чай персоналу..."
        # Олаф возмущенно
        olaf "Тысячу?!"
        olaf "Но, Миссис Бакфетт, нас не обслуживали на такую сумму!"
        # Моника раздраженно
    ...
    if monicaHotelAdminAgreement3 == True and ep212_escort_monica_fired == False:
        ...
        linda "Но Олаф!"
        # Олаф ей шепчет
        olaf "Линда, я дам тебе $ 10 000 прямо сейчас, если ты замолчишь и уйдешь отсюда сейчас же!"
        linda "$ 10 000?!"
        olaf "Да!"
        # отдает ей деньги
        ...
        menu:
            ...
            "Забрать у Линды часть денег.":
                ...
                m "То с этих десяти тысяч ты мне отдашь $ 9 000."
                # Линда шипит
        ...
        m "МЕНЯ!!!"
        m "Эта падшая женщина не достойна даже того, чтобы..."
        if monicaEscortLindaTable1 == True:
            ...
            m "Чтобы находиться в одном со мной помещении!!!"
            m "!!!"
        # Олаф крайне напуган
        olaf "Миссис Ба..."
        ...
        olaf "Я все сделаю..."
        olaf "Только не расстраивайтесь так..."
        ...
        olaf "Я тебе доплачу еще $ 5 000!"
        olaf "Только не спорь с ней! И молчи!"
        linda "Еще $ 5 000?"
        linda "Что ж..."
        linda "Ну хорошо..."
        linda "Но я готова терпеть это только ради тебя!"
        olaf "Да, милая. Пойдем."
        ...
        linda "Но Олаф!"
        olaf "Я тебе заплачу еще $ 1 000."
        olaf "Только будь послушной девочкой."
        ...
        olaf "Мэм, у меня на этот вечер были дргие планы..."
        ...
        olaf "Я тебе заплачу еще $ 10 000!"
        olaf "Только не спорь!"
        linda "!!!"
...
label ep215_dialogues3_escort_15:
    ...
    if monicaHotelAdminAgreement3 == True and ep212_escort_monica_fired == False:
        ...
        if monicaBiffInvestorDate6 == True:
            ...
            m "Она должна мне часть деньги, которые ей заплатил мой клиент!"
            ...
            reception "Линда, мне [monica_hotel_name] говорит, что е сегдняшний клиент заплатил тебе деньги..."
    ...
    if ep212_escort_monica_fired == True:
        ...
        m "Понятно!"
        reception "И вообще!"
        reception "Еще раз увижу тебя в этом отеле - сразу вызову охрану!"
        reception "Я не собираюсь тратить время на такую лгунью и мошенницу, как ты!"
        reception "Тебе все ясно, [monica_hotel_name]?!"
        m "Да пошла ты!"
        # Моника уходит
    else:
...
# после того, как вышла из ресторана, где ужинала с Олафом
...
# другой день, после встречи с Олафом
# кабинет Бифа
label ep215_dialogues3_escort_21:
    ...
    biff "Цыпочка заставила еще одного денежного мешка расщедриться для моего журнала!"
