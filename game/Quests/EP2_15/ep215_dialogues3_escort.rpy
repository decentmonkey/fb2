...
label ep215_dialogues3_escort_8:
    ...
    charlotte "Олаф, ты же не против если мы присоединимся к вам?"
    charlotte "Ведь у тебя нет никаких секретов от меня?"
    # Олаф в шоке, боится
    olaf "......" # что-то говорит. да, я не против дорогая...
    # Моника возражает
    m "Я против, Олаф..."
...
#                pass
    ...
    # сначала снимает брюки, Моника закрывает рукой (натягивая юбку)
...
# встреча с Линдой после того как ее унизили (в ресторане)
# Линда очень очень злая (пару фраз)
