...
label ep215_dialogues3_linda_punishment:
    ...
    olaf "Это мне решать! И я не буду помогать тебе, если ты откажешь сейчас!"
...
label ep215_dialogues3_escort_22:
    # Моника за столиком, Линда подходит к ней
    # Линда в ярости, зло шипит на Монику
