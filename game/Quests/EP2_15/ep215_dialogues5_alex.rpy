...
label ep215_dialogues5_alex_1:
    ...
    alex_photograph "Нуу... Не знаю... Я мог бы нарушить свои правила..."
    alex_photograph "Например, ради девушки, с которой я сплю..."
    ...
    victoria "Я могла бы провести с тобой вечер."
...
label ep215_dialogues5_alex_3:
    ...
    victoria "Подружка, скажи Алексу, что ты не против, чтобы я переспала с ним."
    victoria "И не будешь ревновать."
    menu:
        "Я не против.":
    ...
    alex_photograph "Ну раз ты не против, Мелани..."
    ...
    victoria "Мне не терпится почувствовать твой член внутри себя!"
    ...
    victoria "Подружка Мелани, можешь завершить съемку."
...
label ep215_dialogues5_alex_6:
    ...
    m "Это все маска, Дик! Она тебя обманывает!"
    ...
    melanie "И переживаем из-за того, что вас обманывает эта девочка."
    # Дик слушает Мелани, он в шоке
    dick "Мелани, я давно знаю Викторию."
    dick "Она искренняя и добрая девушка."
    dick "Виктория не способна на обман."
    # Моника психует
    ...
    victoria "Мне нечего от вас скрывать!"
    ...
    # Виктория невинно
    victoria "Дик, дорогой, ты ведь его знаешь..."
    dick "Знаю? И какой же он?"
    victoria "Это твой день рождения, дорогой."
    victoria "Ведь мне нечего от тебя скрывать..."
...
###############
    ...
    m "Но Дик!"
    dick "Тихо! Больше ни слова не хочу слышать!"
    # Дик возмущается на Мелани и Монику
    dick "Вы обе не стоите и мизинца этой девушки!"
    ...
    victoria "Дик, дорогой, я не в обиде на них."
    victoria "Не нужно их наказывать, дорогой."
    dick "Виктория, как ты можешь за них заступаться?!"
    dick "Я вообще ничего общего не хочу с ними иметь!"
    # Виктория продолжает его успокаивать
    victoria "Все хорошо, дорогой."
    ...
    victoria "Нет, дорогой. Я не хочу, чтобы ты их наказывал."
    victoria "Мы просто попросим их покинуть твой кабинет и больше сюда не возвращаться."
    victoria "Мне кажется, этого будет достаточно, милый."
...
label ep215_dialogues5_alex_7:
    ...
    victoria "Ой, подружки, я так рада видеть вас здесь!"
    victoria "Я тут подумала, что мы давно не устраивали девичники!"
    victoria "Я как раз собиралась устроить особенный девичник!"
    victoria "Вы же не против будете прийти на него, подружки?"
    victoria "Ведь это будет девичник специально для вас!"
    # Моника и Мелани в шоке переглядываются
    m "!!!"
    melanie "!!!"
    victoria "Вы ведь подружки придете?"
