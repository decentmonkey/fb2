...
default monicaAshleyBerkelbauch3 = 0 # Моника отказалась делать минет банкиру
...
label ep218_dialogues1_pub_1:
    ...
    mt "Надо бы спросить у нее, что она решила по поводу ухода с этой дыры."
    ...
    clare "Конечно, для меня это неприемлемо."
...
# Моника приходит на работу в след. смену Клэр
# при условии, что Клэр полностью разделась на сцене
# Моника в одежде шлюхи
...
label ep218_dialogues1_pub_5:
    ...
    menu:
        ...
        "Не делать этого!":
            ...
            m "Нет! Я Королева и мне плевать на какеи-то там обязанности!"
    ...
    mt "Жалкий ничтожный банковский клерк!"
    mt "Строит из себя финансового магната!"
    ...
    banker "Не думаю, что танца этой Королевы достаточно для открытия кредитной линии..."
    ...
    banker "Наклонилась и сделала так..."
    ...
    m "..."
    m "Что делать?!"
    ashley "Подойди к Мистеру Беркельбауху, наклонись и открой рот!"
    ...
    menu:
        "Сделать, как говорит Эшли.":  # коррапшн
            pass
        "Не делать этого!":
            $ monicaAshleyBerkelbauch3 = day # Моника отказалась делать минет банкиру
    ...
    mt "Вот черт!"
    mt "Они заставляют меня взять в рот его мерзкий отросток!"
    mt "Фу!!!"
    mt "!!!"
    mt "Как мне поступить?"
    mt "Ведь если я сейчас откажусь, то эта гребаная извращенка Эшли..."
    mt "Черт! Она сказала, что Молли была лучшей королевой, чем я!"
    mt "А это не так!"
    mt "Я здесь лучшая! Со мной никто не сравнится!"
    mt "!!!"
    mt "Я не допущу, чтобы эта дура Эшли ставила под сомнение мой статус!"
    ...
    banker "И уже завтра деньги будут у нее."
    ...
    banker "Ммммм..."
    # Моника ускоряется
    banker "Давай поглубже, Королева..."
    banker "Оооо..."
    banker "Да, тааак..."
    banker "Ааааа..."
    ...
    # Моника вытирает рот или лицо и зло смотрит на банкира и на Эшли
    mt "Омерзительно!"
    mt "Гадко! Фу!"
    mt "!!!"
    ...
    mt "Они у меня все до вдиного поплатятся за то, что мне приходится терпеть!"
    mt "!!!"
    # затемнение
    return
...
label ep218_dialogues1_pub_6a:
    ...
    banker "Сейчас я буду производить комплексную оценку для обеспечения кредита, Эшли."
    ...
    banker "Тебе придется сделать еще кое-что..."
    # показательно смотрит на свой член
    banker "Для глубокой оценки платежеспособности клиента..."
    banker "Нужно провести, соответственно, глубокий анализ, Эшли."
    banker "И если я останусь доволен, тогда считай, что кредит тебе одобрен."
    ...
    banker "Наклонись и сделай так, чтобы я признал твою платежеспособность удовлетворительной."
    ashley "К-какой?"
    banker "Не вникай, Эшли. Просто наклонись и открой рот."
    banker "Если ты, конечно, не передумала кредитоваться в моем банке."
    # Эшли наклоняется
    ashley "Я..."
    banker "Ты же не передумала, Эшли? Тебе все еще нужны эти деньги?"
    banker "Сделай это. И уже завтра деньги будут у тебя."
    ashley "Конечно, я не передумала, Мистер Беркельбаух!"
    # лицо уже близко к члену
    # он держит член в своей руке и водит головкой по губам Эшли
    ashley "А банк мне одобрит всю сумму, которую я просила?"
    banker "Да, Эшли. Лизни его."
    # Эшли высовывает язык и облизывает головку
    ashley "Уже завтра?"
    banker "Завтра, все верно. Возьми его в рот."
    ...
    # Эшли выпускает его член и бежит за диван
    ...
    banker "Да, Джо... Я жу эту вашу королеву."
    ...
    ashley "Мистер Беркельбаух, а вы еще не приняли решение по моей платеже... Как там? Платежегодности?"
    banker "Я еще не признал твою платежеспособность достаточно удовлетворительной."
    # показывает на свой член
    banker "Возьми его в рот и продолжай."
    # Эшли наклоняется и берет в рот член банкира
    banker "Мммм..."
    banker "Давай поглубже, Эшли..."
    banker "Оооо..."
    banker "Да, тааак..."
    banker "Ааааа..."
    ...
    menu:
        ...
        "Кончить в рот Эшли.":
            ...
            pass
    # банкир расслабленно откидывается на диван
    # Эшли вытирает рот или лицо и смотрит на него вопросительно
    ashley "Ну как, Мистер Беркельбаух?"
    ashley "Банк одобряет мне кредит?"
    banker "Хе-хе!"
    banker "Поздравляю тебя, Эшли. Оценка прошла успешно."
...
label ep218_dialogues1_pub_8:
    ...
    ashley "[monica_pub_name]..."
    ashley "Ты хорошо поработала своей королевской попкой."
    ashley "Мистер Беркельбаух доволен тобой."
    m "Еще бы! Я и не смоневалась!"
