...
label ep218_dialogues1_pub_1:
    ...
    mt "Такие порядочные девушки, как она, не стаанут раздеваться на сцене!"
    mt "А я..."
...
label ep218_dialogues1_pub_6a:
    ...
    ashley "Может, я вместо этого могу предоставить вам какое-то обеспечение по кредиту?"
    banker "Какое обеспечение ты можешь предооставить, Эшли?"
    ...
    banker "И тебе радоваться бы, что у тебя появился хоть какой-то шанс получить кредитный лимит."
    banker "А ты еще сомневаешься в чем-то."
    banker "В общем, мне надоело это."
    banker "Или ты сейчас сделаешь это..."
    banker "Или мы закрываем этот вопрос без возможности возобновить наши переговоры и я ухожу."
    ashley "..."
    banker "Ну так что?"
    ashley "..."
    ...
    banker "Мы подпишем все необходимые документы."
    # Эшли обиженно
    ashley "С-спасибо, Мистер Беркельбаух!"
    banker "Ты довольна, Эшли?"
    ashley "Да, Мистре Беркельбаух..."
    ashley "Вы меня так выручаете..."
    banker "Обращайся, Эшли! Хе-хе!"
    # затемнение
    return
