label marcus_cabinet_dialogue1:
    detective "Сэр."
    img 2086
    with fadelong
    w
...
label marcus_cabinet_dialogue2:
    music Pyro_Flow
    img 2089
    with fadelong
...
label marcus_cabinet_dialogue3:
    ...
    call change_scene("police_marcuscabinet", "Fade", False)
    return


label marcus_cabinet_dialogue4:
    img 2127
    with fadelong
    w
    img 2128
...
label marcus_cabinet_dialogue5:
    img 2143
    with fadelong
    m "С КАКОЙ СТАТИ???"
    img 2142
...
label marcus_cabinet_dialogue6:
    img 2146
    with fadelong
    m "ХОЧУ!!!"
    img 2147
...
label marcus_cabinet_dialogue7:
    img 2148
    with fadelong
    m "И??"
    "ЭТО НЕЗАКОННО???"
...
label marcus_cabinet_dialogue8:
    img black_screen
    with Dissolve(1)
...
label marcus_cabinet_dialogue9:
    img 2587
    with fadelong
...
label marcus_cabinet_dialogue10:
    music Groove2_85
    img 2592
    with fadelong
    marcus "Здравствуйте, Миссис Бакфетт."
...
label marcus_cabinet_dialogue13:
    ...
    call change_scene("police_entrance_s2")
