label julia_day2_evening(obj_name, obj_data):
    ...
    if obj_data["action"] == "l":
        call floor1_monica_julia_revenge_interact_look()
        return
    if obj_data["action"] == "t":
        if monicaEated == True:
            call julia_day2_evening_monica_eated()
            return
...
label julia_day2_evening_monica_eated:
    if juliaMonicaYell == False and juliaPunished == False:
        $ imageName = "4254" + day_suffix
        img imageName
