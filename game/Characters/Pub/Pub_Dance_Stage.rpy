...
label pub_dance1_stage_start1:
    ...
    python:
        excitementTableUp = [
            [1,3,5], #1 - бар от 0 до 27 - 4 бакса чаевых
            [1,3,5], #2
            [1,3,5], #3
            [1,3,5], #4 - бар от 27 до 54 - 7 баксов чаевых
            [1,3,5], #5
            [1,3,5], #6

            [2,5,8], #7 - бар от 54 до 69 - 11 баксов чаевых
            [2,5,8], #8 - бар от 69 до 84 - 20 баксов
            [2,5,8], #9 - бар от 84 до 99 - 35 баксов (максимум 99 баксов, 30% - 29.7 баксов)
        ]
        excitementTableDown = [
            [2,2,2], #1
            [2,2,2], #2
