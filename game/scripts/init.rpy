...
label define_autorun:
    ...
    $ char_info = {
        ...
        "DickSecretary":{"name": _("Виктория"), "enabled":False, "face":"Face_DickSecretary", "style":"char_face_style1_pink",  "bar_suffix": "pink", "level":1, "current_progress":0, "caption": _(""), "max_progress":100, "uplevel_label":"dickSecretaryProgressLevelUp", "progress_label":False, "progress_caption":"Progress lvl.", "caption_diabled":_("Work in progress...")},
