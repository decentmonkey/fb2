...
translate german dick_office_entrance_environment_73ab2137:

    # mt "Здесь обитает Дик..."
    mt "Dick wohnt hier..."

# game/Rooms/Dick_Office/dick_office_entrance.rpy:41
translate german dick_office_entrance_environment_14773750:

    # mt "Мне кажется она старовата для работы здесь."
    # "Хотя для своего возраста она выглядит неплохо."
    mt "Ich denke, sie ist zu alt um hier zu arbeiten."
    "Obwohl sie für ihr Alter gut aussieht."

# game/Rooms/Dick_Office/dick_office_entrance.rpy:44
translate german dick_office_entrance_environment_2458f3fe:

    # reception_secretary "Мэм."
    # "Проходите."
    reception_secretary "Meine Dame."
    "Gehen Sie."

# game/Rooms/Dick_Office/dick_office_entrance.rpy:49
translate german dick_office_entrance_environment_44e9fa83:

    # mt "За этой стойкой находится рецепшин на входе в офисное здание Дика."
    mt "Hinter diesem Tresen ist die Rezeptionistin zu Dick's Büro."

# game/Rooms/Dick_Office/dick_office_entrance.rpy:51
translate german dick_office_entrance_environment_ed2a7992:

    # mt "Красивый цветок, но мне сейчас не до красоты..."
    mt "Eine wunderschöne Blume, aber ich brauche die jetzt nicht..."

# game/Rooms/Dick_Office/dick_office_entrance.rpy:53
translate german dick_office_entrance_environment_f2444813:

    # mt "Надо же? Фото-картина в здании Дика?"
    # "Не ожидала от этого толстяка..."
    # "Но мне сейчас не до этого!"
    mt "Wow. Ein Bild von Dick's Gebäude?"
    "Ich habe diesen Fetti nicht erwartet..."
    "Das brauche ich jetzt auch nicht!"

# game/Rooms/Dick_Office/dick_office_entrance.rpy:57
translate german dick_office_entrance_environment_e7cdc9b4:

    # mt "Ваза... Судя по виду дорогая..."
    mt "Eine Vase... Sieht teuer aus..."

# game/Rooms/Dick_Office/dick_office_entrance.rpy:59
translate german dick_office_entrance_environment_92ec5bf2:

    # mt "Хорошо что я вовремя заметила эту огромную люстру!"
    # "Я буду обходить это место..."
    mt "Ich habe diese große Lampe gerade noch rechtzeitig bemerkt!"
    "Ich gehe um diesen Ort herum..."
