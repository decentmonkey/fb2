...
translate german ep210_dialogues6_gun_monica_fred_1a_4db5ceb4:
    ...
    mt "Morgen brauche ich viel Kraft..."
...
translate german ep210_dialogues6_gun_monica_fred_1b_8104e016:
    ...
    mt "Also..."
    mt "Ich werde diese Erniedrigungen nicht weiter hin nehmen..."
    mt "Ich bin die Königin!"
    mt "Ich werde nicht mehr auf eine Gelegenheit warten oder dass mir jemand das gibt, was mir gehört!"
    mt "Ich werde alles nun selbst in die Hand nehmen. ICH alleine!!!"
    mt "..."
    mt "Aber, ich brauche einen Plan..."
    ...
    mt "..."
    mt "Wer ist sonst noch involviert?"
    mt "Monica, denk nach..."
    mt "..."
    mt "Fred!"
    mt "Als ich Dick verlassen habe, wusste er bescheid!"
    mt "Er wusste alles, was mir widerfahren ist."
    mt "Aber woher?!"
    mt "Ich fange bei Fred an, diesem Bastard..."
...
translate german ep210_dialogues6_gun_monica_fred_1c_e2f39a4f:
    ...
    mt "Fred ist meisten im Hof beim Auto..."
...
translate german ep210_dialogues6_gun_monica_fred_1d_0b31ad3b:
    ...
    # m "Вот ты и попался..."
    m "Fred, hallo..."
    fred "Hallo Frau Buckfett..."
    fred "Sie sehen heute gut aus..."
    m "Danke, Fred..."
    m "..."
    m "Fred?"
    fred "Ja, Frau Buckfett..."
    m "Ich möchte mich dafür entschuldigen, dass ich nicht immer höflich zu dir war..."
    fred "?"
    m "Die Sache ist die, ich habe eingesehen, wie schlau du eigentlich bist..."
    m "Du hast überall hin Beziehungen..."
    m "In Anbetracht meiner Lage bin ich besser mit dir befreundet..."
    fred "Ich bin froh, dass sie das nun endlich auch so sehen, Frau Buckfett!"
    fred "Also, wie sollen wir das anstellen?"
    m "Ich weiß, worauf du raus willst, Fred..."
    m "Ich gehe mit dir ins Bett, aber dafür wirst du mir helfen..."
    fred "Natürlich, Frau Buckfett... Ihnen zu helfen ist meine Pflicht als Profi!"
    fred "Aber sie müssen wissen, dass eine professionelle Freundschaft gewisse Voraussetzungen mit sich bringt..."
    m "Welches Kleid?"
    fred "Sie müssen ihre Dienste jederzeit zur Verfügung stellen, wenn ich es will."
    m "Ja... Fred.. Verstehe..."
    ...
    m "Wenn du möchtest..."
    fred "Ja, Frau Buckfett."
    fred "Ich kenne mich dort gut aus. Gehen wir'"
    fred "Oh, Frau Buckfett... Sie haben kein Höschen an..."
    m "Ja, Fred..."
    m "Ich habe sie extra nicht an, damit du mich jederzeit benutzen kannst..."
    fred "Und ich dachte, das sind die Regeln des Hauses..."
    fred "Welche von dem kleinen Lord aufgesetzt wurden..."
    m "Diesmal habe ich sie nur wegen dir nicht an, Fred..."
    fred "Wie süß!"
    fred "Bücken sie sich, Frau Buckfett..."
    fred "Es ist an der Zeit, unsere professionelle Freundschaft zu beginnen!"
    m "Ja, Fred... einen Moment noch..."
    m "Oh hallo Gürkchen..."
