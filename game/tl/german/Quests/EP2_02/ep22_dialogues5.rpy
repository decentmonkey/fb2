...
translate german strings:
    ...
    new "Моника опоздала, потому что терла пятно"
    ...
    new "Попробовать соблазнить Дика как это делает Виктория (low corruption, required [monicaDickSeduceAsVictoriaByAssCorruptionRequired]) (disabled)"

    # game/Quests/EP2_02/ep22_dialogues5.rpy:529
    old "Попробовать соблазнить Дика как это делает Виктория (corruption)"
    new "Попробовать соблазнить Дика как это делает Виктория (corruption)"

    # game/Quests/EP2_02/ep22_dialogues5.rpy:808
    old "Я согласна... (у меня нет другого выбора, иначе меня сейчас схватят!)"
    new "Я согласна... (у меня нет другого выбора, иначе меня сейчас схватят!)"

    # game/Quests/EP2_02/ep22_dialogues5.rpy:868
    old "Поцеловать каблук Виктории (у меня нет выбора...)"
    new "Поцеловать каблук Виктории (у меня нет выбора...)"
    ...
    new "Я считаю что то что я поцеловала Ваш каблук - достаточно для начала нашей дружбы, Мисс Виктория..."

    # game/Quests/EP2_02/ep22_dialogues5.rpy:937
    old "Лизнуть зад Виктории... (corruption)"
    new "Лизнуть зад Виктории... (corruption)"

    # game/Quests/EP2_02/ep22_dialogues5.rpy:937
    old "Лизнуть зад Виктории... (low corruption, required [monicaVictoriaLickAssBeginCorruptionRequired]) (disabled)"
    new "Лизнуть зад Виктории... (low corruption, required [monicaVictoriaLickAssBeginCorruptionRequired]) (disabled)"
    ...
    new "Поцеловать зад Виктории (у меня нет выбора...)"
    ...
    new "Засунуть язык глубоко в анальное отверстие Виктории..."

    # game/Quests/EP2_02/ep22_dialogues5.rpy:1651
    old "Можно, Мистер Дик..."
    new "Можно, Мистер Дик..."

    # game/Quests/EP2_02/ep22_dialogues5.rpy:1651
    old "Вы уже опоздали, Мистер Дик..."
    new "Вы уже опоздали, Мистер Дик..."

    # game/Quests/EP2_02/ep22_dialogues5.rpy:1651
    old "Я бы хотела чтобы Миссис Бакфетт первая сделала это... (отказать)"
    new "Я бы хотела чтобы Миссис Бакфетт первая сделала это... (отказать)"
