...
translate english monica_office_photostudio_environment_cfb586fd:
...
translate english monica_office_photostudio_environment_163e48fd:
    ...
    mt "That's the counter light. Color."

# game/Rooms/Monica_Office/monica_office_photostudio.rpy:78
translate english monica_office_photostudio_environment_7bd32022:

    # mt "Эти прожекторы освещают модель сверху, а также подсвечивают фон за ней."
    mt "These spotlights illuminate the model from above, as well as illuminate the background behind her."
