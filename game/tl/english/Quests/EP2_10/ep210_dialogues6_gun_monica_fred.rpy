...
translate english ep210_dialogues6_gun_monica_fred_1a_4db5ceb4:

    # mt "Мне надо лечь спать..."
    # mt "Завтра мне понадобятся силы..."
    mt "I need to go to bed..."
    mt "Tomorrow I will need strength..."

# game/Quests/EP2_10/ep210_dialogues6_gun_monica_fred.rpy:9
translate english ep210_dialogues6_gun_monica_fred_1b_8104e016:
    ...
    mt "So..."
    mt "I will no longer tolerate this... humiliation..."
    mt "I am the Queen!"
    mt "And I'm not going to wait for an opportunity or for someone to return to me what is mine!"
    mt "Instead, I myself will take what belongs to ME!!!"
    mt "..."
    mt "But, I still need a plan..."
    ...
    mt "..."
    mt "Who else is involved in this...?"
    mt "Think, Monica, think..."
    mt "..."
    mt "Fred!"
    mt "When I left Dick's place, he knew!"
    mt "He knew about everything that happened to me!"
    mt "Where from?!"
    mt "I'll start with Fred, this bastard..."

# game/Quests/EP2_10/ep210_dialogues6_gun_monica_fred.rpy:33
translate english ep210_dialogues6_gun_monica_fred_1c_e2f39a4f:

    # mt "Фред обычно во дворе у машины..."
    mt "Fred is usually in the courtyard near the car..."

# game/Quests/EP2_10/ep210_dialogues6_gun_monica_fred.rpy:39
translate english ep210_dialogues6_gun_monica_fred_1d_0b246813:

    # mt "Ага, вот он..."
    mt "Yeah, there he is..."

# game/Quests/EP2_10/ep210_dialogues6_gun_monica_fred.rpy:41
translate english ep210_dialogues6_gun_monica_fred_1d_0b31ad3b:
    ...
    # m "Вот ты и попался..."
    m "Hi, Fred..."
    fred "Hello, Mrs. Buckfett ..."
    fred "You look great today..."
    m "Thanks, Fred..."
    m "..."
    m "Fred?"
    fred "Yes, Mrs. Buckfett ..."
    m "Fred, I would like to apologize for not being polite with you..."
    fred "?"
    m "The thing is, I realized how smart you are..."
    m "You have connections everywhere and..."
    m "Given my position, I better be friends with you..."
    fred "I'm glad you finally understood it, Mrs. Buckfett!"
    fred "So, how are you going to be friends with me?"
    m "I understand, Fred, what you mean by that word..."
    m "I agree to sleep with you Fred, but you will help me for that..."
    fred "Of course, Mrs. Buckfett... Helping you is my professional duty!"
    fred "But you must understand that professional friendship carries a certain requirement..."
    m "What dress?"
    fred "You will have to provide me with professional services at any time the need for them arises..."
    m "Yes... Fred... I understand..."
    m "I agree to provide you my... professional services..."
    m "Anytime you wish..."
    fred "I'm glad to hear that, Mrs. Buckfett! Our professional friendship will be long and fruitful!"
    m "Maybe you want to use me right now?"
    fred "Oh Mrs. Buckfett! It was very professional from you to offer this!"
    m "I have... my own bedroom in the basement..."
    m "If you feel comfortable ..."
    fred "Mrs. Buckfett."
    fred "It will be quite convenient for me there. Come along!"
    fred "Oh, Mrs. Buckfett... You 're not wearing panties..."
    m "Yes, Fred..."
    m "I didn't put them on, so you could conveniently use me at any time ..."
    fred "And I thought you were following the rules of this house..."
    fred "Which the young master has established..."
    m "This time I did not wear panties specifically for you, Fred..."
    fred "How cute ..."
    fred "Bend down, Mrs. Buckfett..."
    fred "It's time to start our professional friendship!"
    m "Yes, Fred... One moment..."
    m "Well hello pickle ..."
    m "Got you..."
