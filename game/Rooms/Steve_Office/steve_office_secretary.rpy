...
label steve_office_secretary_init:
    ...
    $ add_object_to_scene("Teleport_Street", {"type":3, "text" : _("НАЗАД НА УЛИЦУ"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "steve_office_secretary_teleport", "xpos" : 960, "ypos" : 956, "zorder":15, "teleport":True}, scene="steve_office_secretary")
