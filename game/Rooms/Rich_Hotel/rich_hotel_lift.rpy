...
label rich_hotel_lift_init:
    ...
    $ add_object_to_scene("Teleport_Reception", {"type":3, "text" : _("ВЫХОД"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "rich_hotel_lift_teleport", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True, "high_sprite_hover":True}, scene="rich_hotel_lift")
