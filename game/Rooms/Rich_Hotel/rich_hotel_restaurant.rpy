...
label rich_hotel_restaurant_init:
    ...
    $ add_object_to_scene("Teleport_Reception", {"type":3, "text" : _("ВЫХОД"), "larrow" : "arrow_left_2", "base":"RichHotel_Restaurant_TeleportReception", "click" : "monicahome_livingroom_teleport", "xpos" : 752, "ypos" : 114, "zorder":1, "teleport":True}, scene="rich_hotel_restaurant")
