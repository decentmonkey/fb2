...
label bathroom_shower_init:
    ...
    $ add_object_to_scene("Teleport_Floor2", {"type":3, "text" : _("НАЗАД"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "bathroom_teleport", "xpos" : 990, "ypos" : 956, "zorder":11, "high_sprite_hover": True, "teleport":True})
    $ add_object_to_scene("Teleport_Bathroom_Bath", {"type":3, "text" : _("ВАННА"), "larrow" : "arrow_left_2", "base":"Screen_Left_Arrow_Tight", "click" : "bathroom_teleport", "xpos" : 240, "ypos" : 520, "zorder":11, "teleport":True})
