...
#    $ add_object_to_scene("Teleport_House_Fence_Scratch", {"type":3, "text" : _("ЦАРАПИНА"), "rarrow" : "arrow_up_2", "base":"Street_House_Gate_Teleport_Outside", "click" : "street_house_fence_teleport", "xpos" : 638, "ypos" : 564, "zorder":11})
    $ add_object_to_scene("Teleport_House_Yard", {"type":3, "text" : _("НАЗАД ВО ДВОР"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "street_house_fence_teleport", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True})
    return
...
label street_house_fence_teleport:
    if obj_name == "Teleport_House_Yard":
        call change_scene("street_house_main_yard") from _call_change_scene_173
        return
    if obj_name == "Teleport_House_Outside":
        call change_scene("street_house_outside") from _call_change_scene_174
        return
    return
