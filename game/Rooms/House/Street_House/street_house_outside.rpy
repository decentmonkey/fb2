...
label street_house_outside_init:
    ...
    $ add_object_to_scene("Monica", {"type" : 2, "base" : "Street_House_Outside_Monica_[cloth][day_suffix]", "click" : "street_house_outside_environment", "actions" : "l", "zorder":10, "tint": monica_tint}, {"cloth":{"v":"CasualDress1", "base":"Street_House_Outside_Monica_[cloth]_[street_house_outside_monica_suffix][day_suffix]"}})
