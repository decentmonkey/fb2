...
label street_house_main_yard_init:
    ...
    $ add_object_to_scene("Teleport_House", {"type":3, "text" : _("В ДОМ"), "rarrow" : "arrow_up_2", "base":"Street_House_Teleport_House", "click" : "street_house_main_yard_teleport", "xpos" : 1683, "ypos" : 858, "zorder":11, "b":-0.05, "tint":[1.0, 1.0, 0.85], "teleport":True}, scene="street_house_main_yard")
    ...
    $ add_object_to_scene("Teleport_Fence", {"type":3, "text" : _("К ЗАБОРУ"), "larrow" : "arrow_left_2", "base":"Street_House_Teleport_Fence", "click" : "street_house_main_yard_teleport", "xpos" : 758, "ypos" : 154, "zorder":11, "b":0.15, "tint":[1.0, 1.0, 0.9], "active":False}, scene="street_house_main_yard")

    $ add_object_to_scene("Teleport_Gate", {"type":3, "text" : _("К ВОРОТАМ"), "larrow" : "arrow_left_2", "base":"Street_House_Teleport_Gate", "click" : "street_house_main_yard_teleport", "xpos" : 433, "ypos" : 660, "zorder":11, "b":0.15, "tint":[1.0, 1.0, 0.85], "teleport":True}, scene="street_house_main_yard")
