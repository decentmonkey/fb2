...
#    $ add_object_to_scene("Bardie", {"type" : 2, "base" : "Floor1_Bardie[day_suffix]", "click" : "bardieInteract1", "actions" : "lw", "zorder":10, "active":False}, {"monicaCleaningInProgress":{"v":True, "base":"Floor1_Bardie_Cleaning"}})
...
#    $ add_object_to_scene("Curtains", {"type":2, "base":"Floor1_Curtains", "click" : "floor1_environment", "actions" : "l", "zorder" : 0, "b":0.15, "group":"environment", "cleaning_group":True})
...
#    $ add_object_to_scene("Picture", {"type":2, "base":"Floor1_Picture", "click" : "floor1_environment", "actions" : "l", "zorder" : 0, "group":"environment", "cleaning_group":True})
#    $ add_object_to_scene("Fountain", {"type":2, "base":"Floor1_Fountain_Object", "click" : "floor1_environment", "actions" : "lw", "zorder" : 1, "b":0.03, "group":"environment", "teleport":True})
    $ add_object_to_scene("Fountain", {"type":2, "base":"dust", "img_mask":"Floor1_Fountain_Object", "click" : "floor1_environment", "actions" : "lw", "zorder" : 1, "b":0.03, "group":"environment", "teleport":True})

#    $ add_object_to_scene("Furniture", {"type":2, "base":"Floor1_Furniture", "click" : "floor1_environment", "actions" : "l", "zorder" : 0, "group":"environment", "cleaning_group":True})
...
#    $ add_object_to_scene("Teleport_Kitchen", {"type":3, "text" : _("КУХНЯ"), "larrow" : "arrow_left_2", "base":"Floor1_Teleport_Kitchen", "click" : "floor1_teleport", "xpos" : 130, "ypos" : 758, "zorder":9, "b":0.2, "teleport":True, "high_sprite_hover":True})
