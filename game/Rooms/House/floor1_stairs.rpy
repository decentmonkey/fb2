label floor1_stairs:
    ...
    if bardieLocation == "Floor1_Stairs":
        ...
        $ add_object_to_scene("Bardie", {"type" : 2, "base" : "Floor1_Stairs_Bardie" + day_suffix, "click" : "bardieInteract1", "actions" : "lt", "zorder":10, "icon_t":"/Icons/talk" + res.suffix +".png"})
        $ add_object_to_scene("Teleport_Basement_Pool", {"type":3, "text" : _("ЛЕСТНИЦА В ПОДВАЛ"), "rarrow" : "arrow_down_2", "base":"Floor1_Stairs_StairsDown", "click" : "floor1_stairs_teleport", "xpos" : 535, "ypos" : 365, "zorder":9})
...
label floor1_stairs_teleport(obj_name, obj_data):
    ...
    if obj_name == "Teleport_Basement_Pool":
        ...
        if juliaBasementWarningActive == True:
            call julia_scene_basement1_monica_warning() from _call_julia_scene_basement1_monica_warning
