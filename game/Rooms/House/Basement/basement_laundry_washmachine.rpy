...
label basement_laundry_washmachine_init:
    ...
    $ add_object_to_scene("Teleport_Basement_Laundry", {"type":3, "text" : _("НАЗАД"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "basement_laundry_washmachine_teleport", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True}, scene="basement_laundry_washmachine")
