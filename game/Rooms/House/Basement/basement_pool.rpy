...
label basement_pool_init:
    ...
    $ add_object_to_scene("Bidet", {"type":2, "base":"Basement_Pool_Bidet_b", "click" : "basement_pool_environment", "actions" : "l", "zorder" : 0, "group":"environment"})
    ...
    $ add_object_to_scene("Shower_Cabin", {"type":2, "base":"Basement_Pool_Shower_Cabin_b", "click" : "basement_pool_environment", "actions" : "l", "zorder" : 0, "group":"environment"})
