...
#    $ add_object_to_scene("Teleport_Hostel_1_a", {"type":2, "base":"hostel_edge_1_b_Teleport_Hostel_Edge_a", "click" : "hostel_edge_1_b_teleport", "actions" : "lw", "zorder" : 11, "b":0.13, "tint":[1.0, 1.0, 0.8]})
    ...
    $ add_object_to_scene("Teleport_Hostel_1_a", {"type":3, "text" : _("ДРУГАЯ СТОРОНА"), "rarrow" : "arrow_right_2", "base":"Hostel_Edge_1_b_Teleport_Hostel_Edge_A", "click" : "hostel_edge_1_b_teleport", "xpos" : 1670, "ypos" : 910, "zorder":15, "teleport":True})
    $ add_object_to_scene("Teleport_Hostel_1_c", {"type":3, "text" : _("УЛИЦА"), "larrow" : "arrow_left_2", "base":"Hostel_Edge_1_b_Teleport_Hostel_Edge_C", "click" : "hostel_edge_1_b_teleport", "xpos" : 600, "ypos" : 963, "zorder":15, "teleport":True})
...
label hostel_edge_1_b_teleport:
    if obj_name == "Teleport_Hostel_1_c":
        if cloth_type == "Nude":
            call change_scene("hostel_edge_1_c", "Fade", "snd_walk_barefoot") from _call_change_scene_176
            return
        call change_scene("hostel_edge_1_c") from _call_change_scene_177
        return
    if obj_name == "Teleport_Hostel_1_a":
        if cloth_type == "Nude":
            call change_scene("hostel_edge_1_a", "Fade", "snd_walk_barefoot") from _call_change_scene_178
            return
        call change_scene("hostel_edge_1_a") from _call_change_scene_179
        return
    return
