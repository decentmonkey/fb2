...
label hostel_street_teleport:
    if obj_name == "Teleport_Hostel_Edge_C":
        if cloth_type == "Nude":
            call change_scene("hostel_edge_1_c", "Fade", "snd_walk_barefoot") from _call_change_scene_99
            return
        call change_scene("hostel_edge_1_c", "Fade", "highheels_run2") from _call_change_scene_100
        return
    if obj_name == "Teleport_Shawarma":
        call change_scene("whores_place_shawarma", "Fade", "highheels_run2") from _call_change_scene_101
        return
    if obj_name == "Teleport_Hostel_Street_Door":
        if act == "l":
            ...
            return
        if act == "w":
            call change_scene("hostel_street_door") from _call_change_scene_102
            return
    return
