...
label hostel_street_door_teleport:
    if obj_name == "Teleport_Hostel_Street":
        if cloth_type == "Nude":
            call change_scene("hostel_street", "Fade", "snd_walk_barefoot") from _call_change_scene_15
            return
        call change_scene("hostel_street") from _call_change_scene_16
        return
    if obj_name == "Teleport_hostel_reception":
        ...
        if act == "w":
            ...
            return
            call change_scene("hostel_reception", "Fade_long", "snd_jail_door") from _call_change_scene_17
            return
        return
    return
