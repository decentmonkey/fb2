...
label street_philiphome_init:
    ...
    $ add_object_to_scene("Teleport_Building", {"type":3, "text" : _("ВХОД"), "larrow" : "arrow_left_2", "base":"Street_PhilippHome_Enter", "click" : "street_philiphome_teleport", "xpos" : 1586, "ypos" : 432, "zorder":15, "teleport":True}, scene="street_philiphome")
    $ add_object_to_scene("Teleport_Map", {"type":3, "text" : _("В ГОРОД"), "larrow" : "arrow_left_2", "base":"empty", "click" : "street_philiphome_teleport", "xpos" : 130, "ypos" : 986, "zorder":15, "teleport":True, "high_sprite_hover":True}, scene="street_philiphome")
    return
