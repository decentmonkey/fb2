...
label map_close:
    ...
    call change_scene(map_source_scene, "Fade", "open_map") from _call_change_scene_136
    return
...
label map_environment:
    ...
    if obj_name == "Teleport_" + map_scene:
        ...
        return
    call process_hooks("map_teleport", "global") from _call_process_hooks_26 #хук перед телепортом из карты
