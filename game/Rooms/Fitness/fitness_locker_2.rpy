...
label fitness_locker_2_init:
    ...
    $ add_object_to_scene("Teleport_Locker", {"type":3, "text" : _("ЖДАТЬ В РАЗДЕВАЛКЕ"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "fitness_locker_2_teleport", "xpos" : 960, "ypos" : 956, "zorder":11}, scene="fitness_locker_2")
