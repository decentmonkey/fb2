...
label whores_place_shawarma_teleport2:
    if obj_name == "Teleport_Clothing_Shop":
        call change_scene("street_cloth_shop", "Fade_long", "highheels_run2") from _call_change_scene_106
        return
    if obj_name == "Teleport_Street_Hostel":
        call change_scene("hostel_street", "Fade", "highheels_run2") from _call_change_scene_107
        return
    if obj_name == "Teleport_Whores_Place":
        call change_scene("whores_place", "Fade", "highheels_run2") from _call_change_scene_108
        return
