...
label monica_office_secretary_teleport:
    if obj_name == "Teleport_Monica_Office_Entrance":
        call change_scene("monica_office_entrance", "Fade_long", "snd_lift") from _call_change_scene_60
        return
    if obj_name == "Teleport_Monica_Office_Cabinet":
        call change_scene("monica_office_cabinet") from _call_change_scene_61
        return
    if obj_name == "Teleport_Monica_Office_Photostudio":
        call change_scene("monica_office_photostudio") from _call_change_scene_62
        return
...
label monica_office_secretary_environment:
    ...
    if obj_name == "Teatable":
        ...
        if obj_data["action"] == "w":
            call change_scene("monica_office_secretary_teatable") from _call_change_scene_64
            return
