...
label monica_office_cabinet_init:
    ...
    $ add_object_to_scene("Teleport_Monica_Office_Secretary", {"type":3, "text" : _("К СЕКРЕТАРЮ"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "monica_office_cabinet_teleport", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True})
    return
