...
label cloth_shop_cashier_init:
    ...
    $ add_object_to_scene("Teleport_Dressing_Room", {"type":3, "text" : _("К ПРИМЕРОЧНОЙ"), "rarrow" : "arrow_right_2", "base":"empty", "click" : "cloth_shop_cashier_teleport", "xpos" : 1640, "ypos" : 152, "zorder":11, "teleport":True}, scene="cloth_shop_cashier")
    $ add_object_to_scene("Teleport_Cloth_Shop_View1", {"type":3, "text" : _("НАЗАД"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "cloth_shop_cashier_teleport", "xpos" : 960, "ypos" : 956, "zorder":11, "teleport":True}, scene="cloth_shop_cashier")
