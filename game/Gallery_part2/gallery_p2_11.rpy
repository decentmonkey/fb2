label gallery_44259:
    ...
    mt "!!!"
#    label gallery_ep22_5_dialogues2_escort2_4a: ### repeat
    ...
    default gallery_ep22_5_dialogues2_escort2_4_menu1 = False
    default gallery_ep22_5_dialogues2_escort2_4_menu2 = False
    default gallery_ep22_5_dialogues2_escort2_4_menu3 = False
    default gallery_ep22_5_dialogues2_escort2_4_menu4 = False
    default gallery_ep22_5_dialogues2_escort2_4_menu5 = False
    ...
    menu:
        "Проголосовать за Миранду.":
            ...
            label gallery_ep22_5_dialogues2_escort2_4b:
            sound highheels_short_walk
            imgd 44274
            ...
            # кадр на девочек
            label gallery_ep22_5_dialogues2_escort2_4_loop1:
            imgf 44297
            w
            menu:
                "Миранда.":
                    ...
                    imgd 44397
                    mt "!!!"
                    $ gallery_ep22_5_dialogues2_escort2_4_menu1 = True
                    jump gallery_ep22_5_dialogues2_escort2_4_loop1
                "Эбби.":
                    ...
                    imgd 44430
                    w
                    $ gallery_ep22_5_dialogues2_escort2_4_menu2 = True
                    jump gallery_ep22_5_dialogues2_escort2_4_loop1
                "Администратор Мэйли." if gallery_ep22_5_dialogues2_escort2_4_menu1 == True and gallery_ep22_5_dialogues2_escort2_4_menu2 == True:
        ...
        "Проголосовать за Эбби.":
            ...
            jump gallery_ep22_5_dialogues2_escort2_4b
    ...
    imgfl 44296
    steve "Кто будет первой?"
    label gallery_ep22_5_dialogues2_escort2_4_loop2:
    imgf 44297
    w
    # кадр на девочек
    menu:
        "Миранда.": # повтор соответствующего пункта выше
            ...
            imgd 44397
            mt "!!!"
            $ gallery_ep22_5_dialogues2_escort2_4_menu3 = True
            jump gallery_ep22_5_dialogues2_escort2_4_loop2
        ...
        "Эбби.": # повтор соответствующего пункта выше
            ...
            imgd 44430
            w
            $ gallery_ep22_5_dialogues2_escort2_4_menu4 = True
            jump gallery_ep22_5_dialogues2_escort2_4_loop2
        "Администратор Мэйли.": # повтор соответствующего пункта выше, кроме концовки
            ...
            imgd 44469
            m "!!!"
            $ gallery_ep22_5_dialogues2_escort2_4_menu5 = True
            jump gallery_ep22_5_dialogues2_escort2_4_loop2
        "Моника." if gallery_ep22_5_dialogues2_escort2_4_menu3 == True and gallery_ep22_5_dialogues2_escort2_4_menu4 == True and gallery_ep22_5_dialogues2_escort2_4_menu5 == True:
            ...
            menu:
                "Пошел он к черту!":
                    label gallery_ep22_5_dialogues2_escort2_4d:
                    music Power_Bots_Loop
                    imgf 44472
            ...
            menu:
                "Пошел он к черту!":
                    jump gallery_ep22_5_dialogues2_escort2_4d
                "Пройти кастинг.":
