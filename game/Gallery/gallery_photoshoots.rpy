...
####            $ biffMonicaLastCastingSkipped = True
        ...
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if (biffMonicaCastingsEnabled == True or monicaWorkingAtBiffOffice == True) and corruption >= photoshoot1_casting_corruption_required: #если есть кастинги
            ...
            call gallery_ep22_photoshoot1_casting()
    ...
    menu:
        ...
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if (biffMonicaCastingsEnabled == True or monicaWorkingAtBiffOffice == True) and corruption >= photoshoot5_casting_corruption_required: #если есть кастинги
            ...
            #если обещала
                "..."
                "Черт... Тем более я ему обещала быть хорошей цыпочкой и, в противном случае, он может перестать давать работу мне..."
            call gallery_ep23_photoshoot5_casting()
            return
...
#    $ shotsTotalAmount
    ...
    menu:
        ...
        "Я не собираюсь никем притворяться!":
            ...
            $ castingCloth = 5
            $ chickMode = False
            call gallery_8442() from _call_gallery_8442_3
            img 9499
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
...
#        alex_photograph "Следующая поза, Миссис Бакфетт!"
        if corruption < PS8_monica_pose2_corruption_required:
            ...
            call corruption_required(PS8_monica_pose2_corruption_required)
            return
    ...
    if result == "down":
        ...
        if corruption < PS8_monica_shot1_corruption_required:
            call corruption_required(PS8_monica_shot1_corruption_required)
            jump expression photoPoseLabel
        # если можно
...
#    20539
    ...
    if result == "down":
        ...
        if corruption < PS8_monica_shot2_corruption_required:
            call corruption_required(PS8_monica_shot2_corruption_required)
            jump expression photoPoseLabel
        # если можно
        alex_photograph "Не переживайте, Миссис Бакфетт!"
        alex_photograph "Из этого ракурса ничего не видно."
...
#    20542
    ...
    if result == "side":
        ...
        if corruption < PS8_monica_shot3_corruption_required:
            call corruption_required(PS8_monica_shot3_corruption_required)
            jump expression photoPoseLabel
...
#    20547
    ...
    if shots == 0 or shotsAmount == 0:
        ...
        if corruption < PS8_monica_pose4_corruption_required:
            call corruption_required(PS8_monica_pose4_corruption_required)
            return
    ...
    if result == "side":
        ...
        if corruption < PS8_monica_shot4_corruption_required:
            call corruption_required(PS8_monica_shot4_corruption_required)
            jump expression photoPoseLabel
    ...
    if result == "down":
        ...
        if corruption < PS8_monica_shot5_corruption_required:
            call corruption_required(PS8_monica_shot5_corruption_required)
            jump expression photoPoseLabel
        alex_photograph "Не переживайте, Миссис Бакфетт!"
        alex_photograph "Из этого ракурса ничего не видно."
        m "Точно?"
...
#        alex_photograph "Следующая поза, Миссис Бакфетт!"
    ...
    #
        if corruption < PS8_monica_pose5_corruption_required:
            call corruption_required(PS8_monica_pose5_corruption_required)
            return
        alex_photograph "Миссис Бакфетт, не переживайте!"
    ...
    if result == "side":
        ...
        if corruption < PS8_monica_shot6_corruption_required:
            call corruption_required(PS8_monica_shot6_corruption_required)
            jump expression photoPoseLabel
    ...
    if result == "down":
        ...
        if corruption < PS8_monica_shot7_corruption_required:
            call corruption_required(PS8_monica_shot7_corruption_required)
            jump expression photoPoseLabel
...
#    20560
    ...
    if shots == 0 or shotsAmount == 0:
        ...
        if corruption < PS8_monica_pose8_corruption_required:
            call corruption_required(PS8_monica_pose8_corruption_required)
            return
...
#    20569
    ...
    if result == "side":
        ...
        if corruption < PS8_monica_shot8_corruption_required:
            call corruption_required(PS8_monica_shot8_corruption_required)
            jump expression photoPoseLabel
        #
    ...
    menu:
        ...
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if (biffMonicaCastingsEnabled == True or monicaWorkingAtBiffOffice == True) and corruption >= photoshoot2_casting_corruption_required : #если есть кастинги
            ...
            if monicaSaidBiffSheIsWillBeAGoodChick == True:
                "..."
                "Черт... Тем более я ему обещала быть хорошей цыпочкой и, в противном случае, он может перестать давать работу мне..."
            call gallery_ep22_photoshoot2_casting() from _call_gallery_ep22_photoshoot2_casting
...
#    $ shotsTotalAmount
    ...
    menu:
        "Притвориться цыпочкой...":
            ...
            $ chickMode = True
            $ castingCloth = 2
            call gallery_8442() from _call_gallery_8442
            img 8462
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
        ...
        "Я не собираюсь никем притворяться!":
            ...
            $ castingCloth = 2
            $ chickMode = False
            call gallery_8442() from _call_gallery_8442_1
            img 8462
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
    ...
    menu:
        ...
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if (biffMonicaCastingsEnabled == True or monicaWorkingAtBiffOffice == True) and corruption >= photoshoot3_casting_corruption_required: #если есть кастинги
            ...
            if monicaSaidBiffSheIsWillBeAGoodChick == True:
                "..."
                "Черт... Тем более я ему обещала быть хорошей цыпочкой и, в противном случае, он может перестать давать работу мне..."
            call gallery_ep22_photoshoot3_casting() from _call_gallery_ep22_photoshoot3_casting
            return
...
#    $ shotsTotalAmount
    ...
    menu:
        "Притвориться цыпочкой...":
            ...
            $ chickMode = True
            $ castingCloth = 3
            call gallery_8442() from _call_gallery_8442_6
            img 8480
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
        ...
        "Я не собираюсь никем притворяться!":
            ...
            $ castingCloth = 3
            $ chickMode = False
            call gallery_8442() from _call_gallery_8442_7
            img 8480
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
...
#    $ shotsTotalAmount
    ...
    menu:
        "Притвориться цыпочкой...":
            ...
            $ chickMode = True
            $ castingCloth = 4
            call gallery_8442() from _call_gallery_8442_4
            img 9476
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
        ...
        "Я не собираюсь никем притворяться!":
            ...
            $ castingCloth = 4
            $ chickMode = False
            call gallery_8442() from _call_gallery_8442_5
            img 9476
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
    ...
    menu:
        ...
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if (biffMonicaCastingsEnabled == True or monicaWorkingAtBiffOffice == True) and corruption >= photoshoot4_casting_corruption_required: #если есть кастинги
            ...
            if monicaSaidBiffSheIsWillBeAGoodChick == True:
                "..."
                "Черт... Тем более я ему обещала быть хорошей цыпочкой и, в противном случае, он может перестать давать работу мне..."
            call gallery_gallery_ep26_photoshoot6_casting() from _call_gallery_gallery_ep26_photoshoot6_casting
            return
...
#    $ shotsTotalAmount
    ...
    menu:
        "Притвориться цыпочкой...":
            ...
            $ chickMode = True
            $ castingCloth = 6
            call gallery_8442() from _call_gallery_8442_10
        ...
        "Я не собираюсь никем притворяться!":
            ...
            $ castingCloth = 6
            $ chickMode = False
            call gallery_8442() from _call_gallery_8442_11
            img 20183 #9476
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
    ...
    if result == "down":
        ...
        menu:
            ...
            "Завершить фотосессию.":
                ...
                return
        music I_Feel_You
        $ add_corruption(30, "gallery_ep26_photoshoot_suit7_optional")
        m "Да, Алекс..."
        m "Я понимаю..."
        img 20165
        with diss
    ...
    menu:
        ...
        "Идти на кастинг к Бифу и притвориться цыпочкой... (corruption)" if (biffMonicaCastingsEnabled == True or monicaWorkingAtBiffOffice == True) and corruption >= photoshoot7_casting_corruption_required: #если есть кастинги
            ...
            if monicaSaidBiffSheIsWillBeAGoodChick == True:
                "..."
                "Черт... Тем более я ему обещала быть хорошей цыпочкой и, в противном случае, он может перестать давать работу мне..."
            call gallery_ep26_photoshoot7_casting() from _call_gallery_ep26_photoshoot7_casting
            return
...
#    $ shotsTotalAmount
    ...
    menu:
        "Притвориться цыпочкой...":
            ...
            $ chickMode = True
            $ castingCloth = 7
            call gallery_8442() from _call_gallery_8442_12
            img 20201 #9476
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
        ...
        "Я не собираюсь никем притворяться!":
            ...
            $ castingCloth = 7
            $ chickMode = False
            call gallery_8442() from _call_gallery_8442_13
            img 20201 #9476
            with fade
            mt "Мерзавец!"
            #рост прогресса у Бифа
